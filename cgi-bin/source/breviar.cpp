...
#define ZOBRAZ_BUTTON_VSETKY_MODLITBY
		...
		/*
			Export("<form action=\"%s?%s=%s"HTML_AMPERSAND"%s=%d"HTML_AMPERSAND"%s=%d"HTML_AMPERSAND"%s=%d"HTML_AMPERSAND"%s=%s%s\" method=\"post\">\n",
				...
				pom);
			Export("<"HTML_FORM_INPUT_SUBMIT2" title=\"%s\" value=\"", nazov_modlitby(i));
...
/* ------------------------------------------- */
	...
	_export_link_show_hide(OPT_2_HTML_EXPORT, BIT_OPT_2_HIDE_OPTIONS1, /* opaËnÈ nastavenie kvÙli öpeci·lnej podmienke, defaulty */ (char *)html_text_option_zobrazit[_global_jazyk], (char *)html_text_option_skryt[_global_jazyk], STR_EMPTY, HTML_CLASS_QUIET, before, after, STR_EMPTY);
...
*/
	...
	_export_link_show_hide(OPT_2_HTML_EXPORT, BIT_OPT_2_HIDE_OPTIONS2, /* opaËnÈ nastavenie kvÙli öpeci·lnej podmienke, defaulty */ (char *)html_text_option_zobrazit[_global_jazyk], (char *)html_text_option_skryt[_global_jazyk], STR_EMPTY, HTML_CLASS_QUIET, before, after, STR_EMPTY);
...
void _export_rozbor_dna_interpretuj_zoznam(short int export_typ, short int typ, short int som_v_tabulke, char batch_command[MAX_STR], short int modlitba, short int d_from_m_from_r_from){
	...
	Log("_export_rozbor_dna_interpretuj_zoznam(): zaËiatok...\n");
...
//	Log("_global_den:\n");	Log(_global_den);
	...
	// 2006-10-18: pridanÈ | 2011-07-09: rozöÌrenÈ
		...
		while(1){
			...
			// zmenene: povodne tu boli pri kazdom parametri aj '1' -- '5'; teraz: vyhodene case '1' -- '5', ktorezto '1' -- '4' su pre options, vid dalej
				...
				case 'h':
					...
					printf("\tBuild: %s\n", BUILD_DATE);
					printf("\t(c)1999-2012 Juraj VidÈky <videky@breviar.sk>\n");
					printf("\n");
					printf("\npouzitie:\n");
