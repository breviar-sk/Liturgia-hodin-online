...
#define HTML_TRANSPARENT_NAV "<div id=\"nav-arrow-up\" class=\"nav-arrow\" onclick=\"window.scrollBy(0, -window.innerHeight)\"></div>\n" \
  "<div id=\"nav-arrow-down\" class=\"nav-arrow\" onclick=\"window.scrollBy(0, window.innerHeight)\"></div>\n"
