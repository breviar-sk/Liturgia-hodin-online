...
// 2013-10-21: doplnenÈ: inverzia pre skrytie rovnak˝ch antifÛn pre mcd
...
struct dm{
	...
	char lc_str_id[MAX_LC_STR_ID]; // liturgickÈ ËÌtania: identifik·tor podæa lc.kbs.sk
};
...
#define BIT_OPT_5_HYMNUS_1VESP           2048 // hymnus pre prvÈ veöpery (CezroËnÈ obdobie: nedeæn˝ alebo z posv. ËÌtania)
