...
const char* html_button_nazov_modlitby_jazyk[POCET_MODLITIEB + 1][POCET_JAZYKOV + 1] =
{
	...
	, { "výber...", "výběr...", "common texts...", "optiones...", "", "výběr...", "közös...", "ru_text", "by_text", "val...", "selección...", "seçimlər...", /* STRING_1_FOR_NEW_LANGUAGE */ }
	, { "všetky", "všechny", "all", "omnia", "", "všechny", "összes", "ru_text", "усе", "allar", "todo", "hamısı", /* STRING_1_FOR_NEW_LANGUAGE */ }
};
...
{ "Zo spoločnej časti", "Společné texty", "Common texts", "Communia", "", "Společné texty", "közös zsolozsmája", "ru_text", "Агульныя тэксты", "Frá almennum textum", "Del común", "Ümumi hissədən", /* STRING_1_FOR_NEW_LANGUAGE */ };

const char* nazov_spolc_oficiumza_jazyk[POCET_JAZYKOV + 1] =
{ "Ofícium za", "Společné texty", "Common texts", "Communia", "", "Společné texty", "közös zsolozsmája", "ru_text", "Агульныя тэксты", "Tíðabænir", "oficio", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ };

// the --CELEBRATION-- for common parts of celebration
const char* nazov_spolc_sviatky_jazyk[POCET_JAZYKOV + 1] =
{ "na sviatky", /*"na svátky"*/"", "", "", "", /*"na svátky"*/"", "", "ru_text", "пра", /*"á hátíðardögum"*/"", "", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */};

// the --ANNIVERSARY-- for common parts of celebration
const char* nazov_spolc_vyrocie_jazyk[POCET_JAZYKOV + 1] =
{ "na výročie", "na výročí", "", "ad anniversarium", "", "na výročí", "", "ru_text", "на", "fyrir árlegan minningardag", "para el aniversario", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ };

const short int nazov_spolc_ciarka_pred_alebo_jazyk[POCET_JAZYKOV + 1] =
{ ANO, ANO, NIE, NIE, NIE, ANO, ANO, NIE, NIE, ANO, NIE, NIE, /* ADD_VALUE_FOR_NEW_LANGUAGE */ };
...
const char* nazov_spolc_jazyk[POCET_SPOL_CASTI + 1][POCET_JAZYKOV + 1] =
{
	...
	{ "duchovných pastierov: pre kňazov", "o duchovních pastýřích (o kněžích)", "", "pastorum: pro presbytero", "", "O duchovních pastýřích – o kněžích", "lelkipásztorok – papok", "ru_text", "пастыраў: пра прэзбітэраў", "fyrir hirða: presta", "de pastores: para un presbítero", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "duchovných pastierov: pre biskupov", "o duchovních pastýřích (o biskupech)", "", "pastorum: pro episcopo", "", "O duchovních pastýřích – o biskupech", "lelkipásztorok – püspökök", "ru_text", "пастыраў: пра біскупаў", "fyrir hirða: biskupa", "de pastores: para un obispo", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "duchovných pastierov: pre pápežov", "o duchovních pastýřích (o papeži)", "", "pastorum: pro papa", "", "O duchovních pastýřích – o papeži", "lelkipásztorok – pápa", "ru_text", "пастыраў: пра папу", "fyrir hirða: páfa", "de pastores: para un papa", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "učiteľov Cirkvi", "o učitelích církve", "", "doctorum Ecclesiæ", "", "O učitelích církve", "egyháztanítók", "ru_text", "доктараў Касцёла", "fyrir kirkjufræðara", "de doctores de la Iglesia", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "apoštolov", "o apoštolech", "", "Apostolorum", "", "O apoštolech", "apostolok", "ru_text", "Апосталаў", "fyrir postula", "de apóstoles", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "jedného mučeníka", "o jednom mučedníkovi", "", "unius martyris – pro viro", "", "O mučedníkovi", "vértanú férfi", "ru_text", /* аднаго */ "мучаніка", "fyrir einn píslarvott", "de un mártir", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "viacerých mučeníkov", "o více mučednících", "", "plurimorum martyrum", "", "O více mučednících", "több vértanú", "ru_text", "некалькіх мучанікаў", "fyrir fleiri en einn píslarvott", "de mártires", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "Panny Márie", "o Panně Marii", "", "Beatæ Mariæ Virginis", "", "O Panně Marii", "Szűz Mária", "ru_text", "Найсвяцейшую Панну Марыю", "fyrir sæla Maríu mey", "de santa María Virgen", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "svätých mužov: pre rehoľníkov", "o svatých mužích (o řeholnících)", "", "sanctorum virorum: pro religiosis", "", "O svatých mužích – o řeholnících", "szerzetes", "ru_text", "святых мужчын: пра законнікаў", "fyrir heilaga menn: klaustur- og reglufólk", "de santos varones: para los religiosos", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "svätých mužov", "o svatých mužích", "", "sanctorum virorum", "", "O svatých mužích", "szent férfiak", "ru_text", "святых мужчын", "fyrir heilaga menn", "de santos varones", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "panien", "o pannách", "", "virginum", "", "O pannách", "szüzek", "ru_text", "паннаў", "fyrir mey", "de vírgenes", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "svätých žien: pre rehoľníčky", "o svatých ženách (o řeholnicích)", "", "sanctarum mulierum: pro religiosis", "", "O svatých ženách – o řeholnicích", "apáca", "ru_text", "святых жанчын: пра законніц", "fyrir heilagar konur: nunnur", "de santas mujeres: para los religiosos", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "svätých žien", "o svatých ženách", "", "sanctarum mulierum", "", "O svatých ženách", "szent asszonyok", "ru_text", "святых жанчын", "fyrir heilagar konur", "de santas mujeres", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "duchovných pastierov: pre viacerých", "o více duchovních pastýřích", "", "plurium pastorum", "", "O více duchovních pastýřích", "több lelkipásztor", "ru_text", "некалькіх пастыраў", "fyrir hirða: fleiri en einn hirði", "de pastores: para varios pastores", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "jednej mučenice", "o jedné mučednici", "", "unius martyris – pro muliere", "", "O mučednici", "vértanú nő", "ru_text", "мyчаніцy", "fyrir píslarvotta úr röðum heilagra kvenna", "de una mártir", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "svätých žien: pre vychovávateľky", "o svatých ženách (o vychovatelkách)", "", "sanctarum mulierum: pro educatoribus", "", "O svatých ženách – o vychovatelkách", "nevelő asszonyok", "ru_text", "святых жанчын: пра выхавацеляў", "fyrir heilagar konur: uppalendur", "de santas mujeres: para los santos educadores", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "svätých mužov: pre vychovávateľov", "o svatých mužích (o vychovatelích)", "", "sanctorum virorum: pro educatoribus", "", "O svatých mužích – o vychovatelích", "nevelő férfiak", "ru_text", "святых мужчын: пра выхавацеляў", "fyrir heilagra karla: uppalendur", "de santos varones: para los santos educadores", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "svätých žien: pre tie, čo konali skutky milosrdenstva", "o svatých ženách (které vynikaly milosrdnými skutky)", "", "sanctarum mulierum: pro iis qui opera misericordiæ exercuerunt", "", "O svatých ženách – o ženě, která vynikala milosrdnými skutky", "jótékonykodó asszonyok", "ru_text", "святых жанчын, якія здзяйснялі ўчынкі міласэрнасці", "fyrir heilagar konur: þær sem vinna miskunnarverk", "de santas mujeres: para los santos que se consagración en alguna actividad caritativa", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	...
	{ "svätých žien: pre viaceré", "o svatých ženách (o více svatých)", "", "plurium mulierum", "", "O svatých ženách – o více svatých", "több szent asszony", "ru_text", "некалькіх святых жанчын", "fyrir heilagar konur:  fleiri en eina", "de santas mujeres", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "svätých mužov: pre viacerých", "o svatých mužích (o více svatých)", "", "plurium virorum", "", "O svatých mužích – o více svatých", "több szent férfi", "ru_text", "некалькіх святых мужчын", "fyrir heilagra karla: fleiri en einn ", "de santos varones", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "viacerých panien", "o pannách – o více pannách", "", "plurium virginum", "", "O pannách – o více pannách", "több szűz", "ru_text", "некалькіх паннаў", "fyrir margar meyjar", "de vírgenes – para múltiples vírgenes", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "posviacky chrámu", "o posvěcení kostela", "", "dedicationis ecclesiæ", "", "Posvěcení kostela", "templomszentelés", "ru_text", "пасвячэнне касцёла", "fyrir vígsluafmæli kirkjunnar", "de la dedicación de una iglesia", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ },
...
const char* nazov_bit_opt_1_spomienka_spol_cast_jazyk[POCET_JAZYKOV + 1] =
{
	...
	"se optó por tomar algunas partes de la conmemoración de la fecha según las Directrices Generales, n. 235 letras. b",
	"az_text",
...
{
	{ "Adventná", "adventní", "", "Adventus", "", "adventní", "Advent", "ru_text", "by_text", "á aðventu", "de adviento", "Advent", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "Adventná", "adventní", "", "Adventus", "", "adventní", "Advent", "ru_text", "by_text", "á aðventu", "de adviento", "Advent", /* STRING_1_FOR_NEW_LANGUAGE */ },
	...
	{ "Vianočná", "vánoční", "", "post Nativitatem", "", "vánoční", "Karácsony", "ru_text", "by_text", "á jólatíð", "de navidad", "Milad", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "Vianočná", "vánoční", "", "post Nativitatem", "", "vánoční", "Karácsony", "ru_text", "by_text", "á jólatíð", "de navidad", "Milad", /* STRING_1_FOR_NEW_LANGUAGE */ },
...
{ "na spomienku" /* Adam: lepšie by bolo: pripomienka */, "pro připomínku", "", "pro commemoratione", "", "pro připomínku", "megemlékezésül", "ru_text", "на ўспамін", "til minningar", "para la conmemoración", "xatirə üçün", /* STRING_1_FOR_NEW_LANGUAGE */ };
...
{
	{ "___", "___", "___", "___", "___", "___", "___", "___", "___", "___", "___", "___", /* STRING_1_FOR_NEW_LANGUAGE */ },
...
const char* nazov_mesiaca_jazyk[POCET_MESIACOV + 1][POCET_JAZYKOV + 1] =
{
	...
	, { "jún", "červen", "June", "iunius", "", "červen", "június", "июнь", "чэрвень", "júní", "junio", "iyun", /* STRING_1_FOR_NEW_LANGUAGE */ }
	, { "júl", "červenec", "July", "iulius", "", "červenec", "július", "июль", "ліпень", "júlí", "julio", "iyul", /* STRING_1_FOR_NEW_LANGUAGE */ }
...
{
	{ "Prvá", "První", "", "Prima", "", "První", "1.", "ru_text", "Першая", "Fyrsti", "Primero", "1-ci", /* STRING_1_FOR_NEW_LANGUAGE */ }
	,{ "Druhá", "Druhá", "", "Secunda", "", "Druhá", "2.", "ru_text", "Другая", "Annar", "Segundo", "2-ci", /* STRING_1_FOR_NEW_LANGUAGE */ }
	,{ "Tretia", "Třetí", "", "Tertia", "", "Třetí", "3.", "ru_text", "Трэцяя", "Þriðji", "Tercero", "3-cü", /* STRING_1_FOR_NEW_LANGUAGE */ }
	,{ "Štvrtá", "Čtvrtá", "", "Quarta", "", "Čtvrtá", "4.", "ru_text", "Чацвёртая", "Fjórði", "Cuatro", "4-cü", /* STRING_1_FOR_NEW_LANGUAGE */ }
	,{ "Piata", "Pátá", "", "Quinta", "", "Pátá", "5.", "ru_text", "Пятая", "Fimmti", "Quinto", "5-ci", /* STRING_1_FOR_NEW_LANGUAGE */ }
	,{ "Šiesta", "Šestá", "", "Sexta", "", "Šestá", "6.", "ru_text", "Шостая", "Sjötti", "Sexto", "6-cı", /* STRING_1_FOR_NEW_LANGUAGE */ }
	,{ "Siedma", "Sedmá", "", "Septima", "", "Sedmá", "7.", "ru_text", "Сёмая", "Sjöundi", "Séptimo", "7-ci", /* STRING_1_FOR_NEW_LANGUAGE */ }
	,{ "Ôsma", "Osmá", "", "VIII", "", "Osmá", "8.", "ru_text", "Восьмая", "Áttundi", "Octavo", "8-ci", /* STRING_1_FOR_NEW_LANGUAGE */ }
	,{ "Deviata", "Devátá", "IX", "", "", "Devátá", "9.", "ru_text", "Дзевятая", "Níundi", "Noveno", "9-cü", /* STRING_1_FOR_NEW_LANGUAGE */ }
	,{ "Desiata", "Desátá", "X", "", "", "Desátá", "10.", "ru_text", "Дзясятая", "Tíundi", "Décimo", "10-cu", /* STRING_1_FOR_NEW_LANGUAGE */ }
...
{
	{ "", "", "", "", "", "", "", "", "", "", "", "", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "Mariánske antifóny", "Mariánské zpěvy", "Mary antiphones", "Antiphonæ B. M. V.", "", "Mariánské antifóny", "Szűz Mária záró-antifónái", "ru_text", "by_text", "Andstef Maríu meyjar", "Antífonas marianas", "Məryəm Anaya himnləri", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "Ordinárium", "Uspořádání", "Ordinary", "Ordinarium", "", "Ordinárium", "Általános rész", "ru_text", "by_text", "Fastir liðir", "Ordinario", "Ordinarium", /* STRING_1_FOR_NEW_LANGUAGE */ },
	{ "Info", "Info", "Info", "Info", "", "Info", "Info", "ru_text", "by_text", "Info", "Info", "Məlumat", /* STRING_1_FOR_NEW_LANGUAGE */ },
};
...
},
{
	...
	"Ciclo" HTML_LINE_BREAK "dominical",
...
},
{
	...
	"Aparición" HTML_LINE_BREAK "del Señor",
...
},
{
	...
	"Bautismo" HTML_LINE_BREAK "del Señor",
...
},
{
	...
	"by_text",
	HTML_A_HREF_BEGIN "\"#explain\">HPA" HTML_LINE_BREAK "ante" HTML_LINE_BREAK "Quadr." HTML_A_END,
	HTML_A_HREF_BEGIN "\"#explain\">TO" HTML_LINE_BREAK "antes" HTML_LINE_BREAK "TdC" HTML_A_END,
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
},
{
	...
	"Öskudagur",
	"Miércoles" HTML_LINE_BREAK "de Ceniza",
...
},
{
	...
	"by_text",
	"Páskadagur",
	"Pascua" HTML_LINE_BREAK "de Resurrección",
...
},
{
	...
	"Ascensión" HTML_LINE_BREAK "del Señor",
...
},
{
	...
	"by_text",
	HTML_A_HREF_BEGIN "\"#explain\">HPA" HTML_LINE_BREAK "post" HTML_LINE_BREAK "temp. pasch." HTML_A_END,
	HTML_A_HREF_BEGIN "\"#explain\">TO" HTML_LINE_BREAK "después" HTML_LINE_BREAK "TP" HTML_A_END,
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
},
{
...
const char* html_text_opt_2_html_export_explain[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"Estas opciones afectarán varias visualizaciones, no el contenido (texto) de las oraciones.",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* html_text_opt_2_navigation_explain[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"Si los hipervínculos a otras oraciones del día en cuestión, o del día anterior o siguiente, deben mostrarse directamente en el texto de la oración.",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* html_text_opt_5_1VHymnusNe[POCET_JAZYKOV + 1] =
{
	...
	"himno para las primeras vísperas",
	"ilk vesperlər üçün himn",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* html_text_opt_5_OCR34Hymns[POCET_JAZYKOV + 1] =
{
	...
	"",
	"hymny pro 34. týden mezidobí",
	"évközi idő 34. hetében vehető másik himnusz választása",
	"ru_text",
	"by_text",
...
const char* html_text_opt_5_Lent5Hymns[POCET_JAZYKOV + 1] =
{
	...
	"",
	"hymny pro 5. týden postní ze Svatého týdne",
	"Nagyböjt 5. hetében himnusz választása a Nagyhétről",
	"ru_text",
	"by_text",
...
const char* html_text_detaily_explain[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"Se utilizarán otras configuraciones de la página anterior (principal)." HTML_P_END "\n" HTML_P_BEGIN "Si algunos parámetros no son aplicables para la oración seleccionada, no se tienen en cuenta (por lo tanto, se pueden configurar arbitrariamente).",
	"Digər parametrlər əvvəlki (əsas) səhifədən istifadə olunacaq." HTML_P_END "\n" HTML_P_BEGIN "Bəzi parametrlər seçilmiş dua üçün uyğun deyilsə, onlar nəzərə alınmır (buna görə də onlar özbaşına təyin oluna bilər).",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* html_text_inv_slavaotcu[POCET_JAZYKOV + 1] =
{
	...
	"Sigue <" HTML_SPAN_NORMAL ">Gloria al Padre" HTML_SPAN_END " y se repite la antífona.",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_JAN_09_ES[POCET_JAZYKOV + 1] =
{
	"",
	"",
	"",
...
const char* text_JAN_14_OFM[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"Pordenonei Boldog Odorik áldozópap, misszionárius",
	"",
	"",
	"",
	"",
...
const char* text_JAN_20_ES[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"San Fructuoso, obispo y mártir, " HTML_LINE_BREAK "y sus diáconos, Santos Augurio y Eulogio",
	"",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_JAN_23_ES[POCET_JAZYKOV + 1] =
{
	"",
	"",
	"",
...
const char* text_MAR_23[POCET_JAZYKOV + 1] =
{
	...
	"Santo Toribio de Mogrovejo, obispo, " HTML_LINE_BREAK "patrono del Episcopado Latinoamericano", // ES: 27APR
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_APR_13_ES[POCET_JAZYKOV + 1] =
{
	"",
	"",
	"",
...
const char* text_APR_17_ES[POCET_JAZYKOV + 1] =
{
	"",
	"",
	"",
	...
	"",
	"",
	"Beata Mariana de Jesús Navarro, virgen",
	"",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_APR_28_2[POCET_JAZYKOV + 1] =
{
	...
	"San Luis María Grignon de Monfort, presbítero",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_APR_29[POCET_JAZYKOV + 1] =
{
	...
	"Santa Catalina de Siena, virgen y doctora de la Iglesia, " HTML_LINE_BREAK "patrona de Europa",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_MAJ_04_ES[POCET_JAZYKOV + 1] =
{
...
const char* text_MAJ_12_OFM[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"Szent Leopold Mandić áldozópap",
	"",
	"",
	"",
	"",
...
const char* text_MAJ_15_ES[POCET_JAZYKOV + 1] =
{
	"",
	"",
	"",
...
const char* text_MAJ_15_OFM[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"Cortonai Szent Margit bűnbánó", // HU: 16MAJ
	"",
	"",
	"",
	"",
...
const char* text_MAJ_18_OFM[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"Cantalicei Szent Félix szerzetes",
	"",
	"",
	"",
	"",
...
const char* text_MAJ_30_ES[POCET_JAZYKOV + 1] =
{
	"",
	"",
	"",
...
const char* text_NEDELA_PANOVHO_ZMRTVYCHVSTANIA[POCET_JAZYKOV + 1] = // 2012-12-13: XML nepodporuje &mdash; -- použitý číselný kód &#8212; http://en.wikipedia.org/wiki/List_of_XML_and_HTML_character_entity_references
{
	...
	HTML_LINE_BREAK "de la Resurrección del Señor",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_DEN_VO_VELKONOCNEJ_OKTAVE[POCET_JAZYKOV + 1] =
{
	...
	"%s у актаве Пасхі",
	"%s á Páskaviku",
	"%s de la Octava de Pascua",
	"%s az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};

// pre HU + IS + ES špeciálny názov veľkonočného pondelka
...
const char* text_KRISTA_KRALA[POCET_JAZYKOV + 1] =
{
	...
	"Nuestro Señor Jesucristo, " HTML_LINE_BREAK "Rey del universo",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_JUN_13_OFM[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"Páduai Szent Antal áldozópap és egyháztanító az I. Rendből",
	"",
	"Св. Антонія Падуанскага, прэзбітэра і доктара Касцёла",
	"",
	"",
...
const char* text_JUN_15_ES[POCET_JAZYKOV + 1] =
{
	"",
	"",
	"",
...
const char* text_JUL_12_OFM[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"Szent Jones János és Wall János áldozópapok, angol vértanúk",
	"",
	"",
	"",
	"",
...
const char* text_JUL_14_OFM[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"San Francisco Solano, presbítero", // Peru only
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_AUG_08_OFM[POCET_JAZYKOV + 1] =
{
	...
	"",
	"Sv. Dominika, kněze",
	"Szent Domonkos atya áldozópap és rendalapító",
	"",
	"",
	"",
	"",
...
const char* text_AUG_09[POCET_JAZYKOV + 1] =
{
	...
	"Santa Teresa Benedicta de la Cruz (Edith Stein), " HTML_LINE_BREAK "religiosa y mártir, patrona de Europa",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_AUG_19_ES[POCET_JAZYKOV + 1] =
{
	"",
	"",
	"",
...
const char* text_AUG_26_OFM[POCET_JAZYKOV + 1] =
{
	...
	"",
	"",
	"Szent Juniper Serra áldozópap és misszionárius ",
	"",
	"",
	"",
	"",
...
const char* text_OKT_03_ES_SJ[POCET_JAZYKOV + 1] =
{
...
{
	"Sv. Jána Henricha Newmana, kňaza a učiteľa Cirkvi",
...
const char* text_NOV_13_ES[POCET_JAZYKOV + 1] =
{
	"",
	"",
	"",
...
const char* text_DEC_10_ES[POCET_JAZYKOV + 1] =
{
	"",
	"",
	"",
...
const char* text_DEC_12[POCET_JAZYKOV + 1] =
{
	...
	"Nuestra Señora de Guadalupe, " HTML_LINE_BREAK "patrona de América Latina y de las Islas Filipinas",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_KVETNA_NEDELA[POCET_JAZYKOV + 1] =
{
	...
	"Pálmasunnudagur",
	"Domingo de ramos " HTML_LINE_BREAK "en la Pasión del Señor",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* text_KONIEC_OKTAVY_NARODENIA_PANA[POCET_JAZYKOV + 1] =
{
	...
	"fin de la Octava de la Natividad del Señor",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
{
	{ "Všeobecné nastavenia", "Obecné nastavení", "General settings", "General settings", "", "Obecné nastavení", "General settings", "General settings", "General settings", "General settings", "Configuración general", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ }
	, { "Zariadenie", "Zařízení", "Device", "Apparatus", "", "Zařízení", "Eszköz", "Device", "Device", "Tæki", "Dispositivo", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ }
	, { "Vzhľad", "Vzhled", "Appearance", "Visual", "", "Vzhled", "Megjelenés", "Appearance", "Appearance", "Útlit", "Apariencia", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ }
	, { "Texty modlitieb", "Texty modliteb", "Prayer texts", "Textus", "", "Texty modliteb", "Imaóra szövege", "Prayer texts", "Prayer texts", "Bænatextar", "Textos de oración", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ }
	, { "Liturgický kalendár", "Liturgický kalendář", "Liturgical calendar", "Calendarium liturgicum", "", "Liturgický kalendář", "Liturgikus naptár", "Liturgical calendar", "Liturgical calendar", "Helgidagatal", "Calendario litúrgico", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ }
	, { "Hlasový výstup", "Hlasový výstup", "Voice output", "Vox output", "", "Hlasový výstup", "Hangkimenet", "Voice output", "Voice output", "Raddúttak", "Salida de voz", "az_text", /* STRING_1_FOR_NEW_LANGUAGE */ }
};
...
const char* menu_text_volume_buttons[POCET_JAZYKOV + 1] =
{
	...
	"Botones de volumen para desplazarse",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* menu_text_lock_font_size[POCET_JAZYKOV + 1] =
{
	...
	"Deshabilitar el gesto de zoom (bloquear el tamaño de fuente)",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
...
const char* menu_text_alt_background[POCET_JAZYKOV + 1] =
{
	...
	"Color de fondo alternativo (amarillo)",
	"az_text",
	/* STRING_2_FOR_NEW_LANGUAGE */
};
