...
/*   26/09/2001A.D. | opravene: sv. TerÈzie Benedikty (sviatok)         */
...
/*   2008-07-03a.D. | sn·Ô opravenÈ kompletÛrium pre sl·vnosti (ocr)    */
...
/*   2009-04-07a.D. | oprava hymnu pre kompletÛrium pre Ëesk˝ brevi·¯                           */
/*   2009-04-16a.D. | opravenÈ kompletÛrium pre veækonoËn˙ okt·vu                               */
/*   2009-05-15a.D. | oprava v set_hymnus(): priradenie namiesto porovnania spÙsobovalo chyby   */
/*   2009-05-22a.D. | ˙prava text_PRO_OP[] - dominik·nske sl·venia neprebÌjaj˙ vöeob. kalend·r  */
/*   2009-07-06a.D. | opravy pre ËeskÈ brevi·re (najm‰ dominik·nsky kalend·r)                   */
/*   2009-07-09a.D. | opravy pre ËeskÈ brevi·re (najm‰ dominik·nsky kalend·r)                   */
/*   2009-07-10a.D. | oprava pre ËeskÈ brevi·re - 12. a 15. septembra                           */
/*   2009-07-27a.D. | oprava viacer˝ch drobn˝ch chybiËiek pre sk aj cz brevi·re                 */
...
/*   2010-05-14a.D. | pre modlitbu cez deÚ doplnenÈ (zatiaæ pre sviatky apoötolov) nastavenie   */
...
/*   2010-07-06a.D. | opravenÈ viacerÈ dominik·nske sl·venia                                    */
/*                  - tam, kde typslav = SLAV_SPOMIENKA ide o dominik·nske, nastavenÈ smer = 11 */
/*                  - neötandardnÈ z·sahy do sl·vnosti Cyrila a Metoda kvÙli CZOP               */
/*   2010-07-08a.D. | zavedenÈ Ôalöie _vlastna_cast_full_okrem_...(); opravy CZOP               */
/*   2010-07-12a.D. | upravenÈ _set_spolocna_cast(): spoloËn· Ëasù na ofÌcium za zosnul˝ch      */
/*                    vûdy berie vlastnÈ ûalmy                                                  */
/*   2010-08-03a.D. | upravenÈ zaltar_kompletorium() a set_hymnus() kvÙli dominik·nom CZOP      */
/*                  - nastavenÈ _global_svaty[1,2,3].kalendar v sviatky_svatych()               */
/*   2010-09-10a.D. | opravy spr·vneho pouûitia responza pred 1. ËÌtanÌm v posv. ËÌtaniach      */
...
/*   2011-01-11a.D. | opravenÈ (podæa latinskÈho) 3.1. (najsv. mena jeûiö) pre inÈ ako czop     */
/*   2011-01-25a.D. | s˙bory chv·lospevov (rannÈ chv·ly a veöpery) premenovanÈ: prefix "ch_";   */
/*                    taktieû premenovanÈ öablÛny (templ·ty) modlitieb; prefix "m_"             */
...
/*   2011-03-14a.D. | na ostatnÈ hodiny modlitby cez deÚ sa berie doplnkov· psalmÛdia (upravenÈ)*/
/*   2011-04-06a.D. | nastavenie antifÛn z doplnkovej psalmÛdie: funkcia                        */
/*                    _set_antifony_mcd_doplnkova_psalmodia(void)                               */
/*   2011-04-28a.D. | oprava kompletÛria v okt·vach (kr·tke ËÌtanie, CZ: aj hymnus (nedeæn˝)    */
/*   2011-06-01a.D. | maÔarsk˝ kalend·r, prv· polovica j˙na                                     */
/*                                                                                              */
/* notes |                                                                                      */
...
#include "breviar.h"  /* pridane 2003-08-13 kvoli _global_opt 5 */
...
/* 2011-03-16: pridanÈ kvÙli spomienkam a æubovoæn˝m spomienkam v pÙstnom obdobÌ (zobrazenie po druhom ËÌtanÌ) */
...
/* pridane 2010-09-14 -- in˝ s˙bor pre modlitby podæa lok·lneho (rehoænÈho) kalend·ra */
...
void set_hymnus(short int den, short int tyzzal, short int modlitba){
	...
	/* 2006-12-04: hymnus pre kompletÛrium je v Ëeskej verzii pre kaûd˝ deÚ in˝ */
	/* 2008-12-16: toto vöak neplatÌ pre Ëesk˝ dominik·nsk˝ brevi·¯ */
	/* 2008-12-17: pre advent II. je predpÌsan˝ hymnus */
	/* 2010-08-03: pre dominik·nsk˝ brevi·¯ nastavenÈ, aby sa hymnus pre kompletÛrium i MCD striedal po t˝ûdÚoch: 
	 *             "V naöÌ provincii se vûil zvyk pro obojÌ - pro komplet·¯ i pro modlitbu bÏhem dne, ûe se pouûÌv· hymnus "A" pro lichÈ a hymnus "B" pro sudÈ t˝dny."
	 */
	if((modlitba == MODL_KOMPLETORIUM) || (modlitba == MODL_PRVE_KOMPLETORIUM)){
		file_name_zapamataj();
		file_name_kompletorium(OBD_CEZ_ROK);
		if((_global_jazyk == JAZYK_CZ) /* || (_global_jazyk == JAZYK_CZ_OP) */){ /* 2008-12-16: pre dominik·nov ako pre slovensk˝ */
			...
			if((_global_den.litobd == OBD_ADVENTNE_I)
			 ...
			 || (_global_den.litobd == OBD_VELKONOCNE_TROJDNIE)
				...
				sprintf(_anchor, "%c_%s_%d", pismenko_modlitby(modlitba), ANCHOR_HYMNUS, (tyzzal) % 2);
			}
		}
...
void set_antifony(short int den, short int tyzzal, short int zvazok, short int modlitba){
	 ...
	 */
			...
			(_global_den.litobd == OBD_VELKONOCNE_II))
		&& 
			(modlitba == MODL_POSV_CITANIE) // 2009-05-15: oprava = na ==
		&& 
			(den == DEN_NEDELA) // 2009-05-15: oprava = na ==, namiesto den by bolo moûnÈ braù aj _global_den.denvt
	){
...
void set_kcitanie(short int den, short int tyzzal, short int modlitba, short int ktore = 2){
	...
	if((modlitba == MODL_KOMPLETORIUM) || (modlitba == MODL_PRVE_KOMPLETORIUM)){
		...
		if((modlitba == MODL_KOMPLETORIUM) && (ktore == 1)){
			/* 2011-04-28: ökared˝ dr·t, ak poûaduje explicitne kompletÛrium po prv˝ch veöper·ch pre okt·vu */
...
void set_hymnus_kompletorium_obd(short int den, short int tyzzal, short int modlitba, short int litobd){
	...
	/* 2008-12-11: pre dominik·nsky rovnako ako pre slovensk˝, teda jeden hymnus VELKONOCNA_NEDELA */
...
void set_kresponz_kompletorium_obd(short int den, short int tyzzal, short int modlitba, short int litobd){
	/* rovnakÈ responzÛrium pre vöetky Ëasti veækonoËnÈho obdobia */
	file_name_zapamataj();
	/* 2009-04-16: opravenÈ, vo veækonoËnej okt·ve je takÈ istÈ k resp. ako vo veækonoËn˙ nedeæu; zmena v nastavenÌ filename */
	...
	/* 2009-04-16: opravenÈ, vo veækonoËnej okt·ve je takÈ istÈ k resp. ako vo veækonoËn˙ nedeæu; zmena v nastavenÌ anchor */
...
void _set_zalmy_mcd_doplnkova_psalmodia(void){
	...
	/* antifÛny nastavuje funkcia _set_antifony_mcd_doplnkova_psalmodia() -- ale len pre cezroËnÈ obdobie; pre vlastnÈ sa pouûÌva define _vlastna_cast_mcd_ant_kcitresp_modl; */
}/* _set_zalmy_mcd_doplnkova_psalmodia() */

/* 2011-04-06: nastavenie spr·vnych antifÛn z doplnkovej psalmÛdie */
void _set_antifony_mcd_doplnkova_psalmodia(void){
	Log("_set_antifony_mcd_doplnkova_psalmodia() -- begin\n");
	char file[SMALL]; /* nazov s˙boru, napr. _1ne.htm */
	char anchor[SMALL];
	short int modlitba;
	mystrcpy(file, FILE_DOPLNKOVA_PSALMODIA, MAX_STR_AF_FILE);
	for(modlitba = MODL_PREDPOLUDNIM; modlitba <= MODL_POPOLUDNI; modlitba++){
		/* modlitba predpoludnim -- napoludnie -- popoludnÌ, 1. aû 3. sÈria doplnkovej psalmÛdie */
...
void _set_kompletorium_nedela(short int modlitba){
	/* popis parametrov:
	 *	- "ktore" -		urËuje, Ëi ide o kompletÛrium po prv˝ch nedeæn˝ch veöper·ch (1) alebo po druh˝ch veöper·ch (2) 
	 *  2008-05-08: prerobenÈ, aby vstupom bol parameter "modlitba" (nie ako doteraz, "short int ktore (1, 2)"
	 */
...
void _set_kompletorium_slavnost_oktava(short int modlitba, short int litobd, short int ktore){
	 ...
	 *	- "ktore" -		urËuje, Ëi ide o kompletÛrium po prv˝ch veöper·ch sl·vnosti (1) alebo po druh˝ch veöper·ch (2) 
	 *  2008-05-08: prerobenÈ, aby vstupom bol parameter "modlitba" (nie ako doteraz, "short int ktore (1, 2)"
	 *  2009-04-16: opraven· modlitba pre veækonoËn˙ okt·vu
	 *  2011-04-28: opravenÈ, aby sa pre veækonoËn˙ okt·vu pre ktore == 1 bralo spr·vne ËÌtanie
	 */
	...
	if(_global_den.denvt == DEN_NEDELA){
		...
		/* 2009-04-16: opraven· modlitba pre veækonoËn˙ okt·vu
		 * 2011-04-29: aj pre vianoËn˙ okt·vu
		 */
		if(litobd == OBD_VELKONOCNA_OKTAVA){
			set_modlitba(DEN_NEDELA, _global_den.tyzzal, modlitba); /* vo veækonoËnej okt·ve sa berie modlitba z nedele */
		}
	}
	else{ /* ktore = 1 */
		 ...
		 */
		if(litobd == OBD_VELKONOCNA_OKTAVA){
			set_modlitba(DEN_NEDELA, _global_den.tyzzal, modlitba, ktore /* == 1 */); /* vo veækonoËnej okt·ve sa berie modlitba z nedele */
		}
		else{
			set_modlitba(DEN_UNKNOWN, _global_den.tyzzal, modlitba); /* je to jeden konkrÈtny deÚ mimo nedele */
		}
 ...
 * k modlitbe
 * 2003-08-13: nakoniec pridane porovnanie s _global_opt 5
 ...
 *
 * 2009-01-06: odvetvenÈ nastavenie vecÌ pre kompletÛrium kvÙli moûnosti samostatne ich nastaviù (napr. kvÙli sviatku Premenenia P·na) 
 *           - logovanie nastavenia ûalmov
 *
 */
...
void zaltar_kompletorium(short int den, short int obdobie, short int specialne, short int tyzzal){
	...
	/* 2006-10-17: pridanÈ kompletÛrium - pÙvodn· pozn·mka z zaltar_zvazok() */
	switch(den){
		case DEN_NEDELA:
		...
		case DEN_UTOROK:
			...
			break;
		case DEN_STREDA:
			set_zalm(1, MODL_KOMPLETORIUM, "z31.htm", "ZALM31,1-6"); /* 2009-02-17: ZmenenÈ; pÙvodne bolo "ZALM31_1_6" */
...
void zaltar_zvazok(short int den, short int tyzzal, short int obdobie, short int specialne){
	 ...
	 *
	 * 2009-01-06: vytvoren· nov· funkcia na debug: set_zalm();
	 *             odËlenenÈ veci pre kompletÛrium, aby sa dali samostatne volaù - zaltar_kompletorium()
	 */
	...
	*/
	...
	Log("nastavujem veci pre kompletÛrium...\n");
	...
	/* 2009-01-06: Ëasti pre kompletÛrium vyÚatÈ do zaltar_kompletorium() */
	switch(den){
		case DEN_NEDELA:
		...
		case DEN_SOBOTA:
			...
			if((tyzzal == 1) || (tyzzal == 3)){
				set_zalm(2, MODL_CEZ_DEN_VSETKY, "z34.htm", "ZALM34_I");
				set_zalm(3, MODL_CEZ_DEN_VSETKY, "z34.htm", "ZALM34_II");
			}
			break;
	}/* switch(den) */
	...
	switch(tyzzal){
		case 1: /* prvy tyzden zaltara */
			switch(den){
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z19.htm", "ZALM19,8-15");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z7.htm", "ZALM7_I");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z7.htm", "ZALM7_II");
				/* vespery */
				...
				/* modlitba cez den */
					...
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z13.htm", "ZALM13");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z14.htm", "ZALM14");
				/* vespery */
				...
				/* modlitba cez den */
					...
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z17.htm", "ZALM17_I");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z17.htm", "ZALM17_II");
				/* vespery */
				...
				/* modlitba cez den */
					...
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z25.htm", "ZALM25_I");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z25.htm", "ZALM25_II");
				/* vespery */
				...
				/* modlitba cez den */
					...
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z26.htm", "ZALM26");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z28.htm", "ZALM28,1-3.6-9");
				/* vespery */
		...
		case 2: /* druhy tyzden zaltara */
			switch(den){
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_VAU");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z40.htm", "ZALM40_I");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z40.htm", "ZALM40_II");
				/* vespery */
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_ZAJIN");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z53.htm", "ZALM53");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z54.htm", "ZALM54");
				/* vespery */
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_CHET");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z55.htm", "ZALM55_I");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z55.htm", "ZALM55_II");
				/* vespery */
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_TET");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z56.htm", "ZALM56");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z57.htm", "ZALM57");
				/* vespery */
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_JOD");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z59.htm", "ZALM59");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z60.htm", "ZALM60");
				/* vespery */
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_KAF");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z61.htm", "ZALM61");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z64.htm", "ZALM64");
				/* posvatne citanie */
					if(je_odlisny_zaltar){
						...
						set_zalm(3, MODL_POSV_CITANIE, "z136.htm", "ZALM136_III_PC"); /* inak je 136 cleneny pre pondelok 4. tyzdna, vespery */
					}
					/* 2005-03-27:
		...
		case 3: /* treti tyzden zaltara */
			switch(den){
				...
				/* posvatne citanie */
					set_zalm(1, MODL_POSV_CITANIE, "z145.htm", "ZALM145pc_I");
					set_zalm(2, MODL_POSV_CITANIE, "z145.htm", "ZALM145pc_II");
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_LAMED");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z71.htm", "ZALM71_I");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z71.htm", "ZALM71_II");
				/* vespery */
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_MEM");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z74.htm", "ZALM74_I");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z74.htm", "ZALM74_II");
				/* vespery */
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_NUN");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z70.htm", "ZALM70");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z75.htm", "ZALM75");
				/* vespery */
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_SAMECH");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z79.htm", "ZALM79");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z80.htm", "ZALM80");
				/* vespery */
				...
				/* ranne chvaly */
					...
					set_zalm(3, MODL_RANNE_CHVALY, "z100.htm", "ZALM100");
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z22.htm", "ZALM22_I");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z22.htm", "ZALM22_II");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z22.htm", "ZALM22_III");
				/* vespery */
				...
				/* ranne chvaly */
					...
					set_zalm(3, MODL_RANNE_CHVALY, "z117.htm", "ZALM117");
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_AIN");
				/* posvatne citanie */
		...
		case 4: /* stvrty tyzden zaltara */
			switch(den){
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_PE");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z82.htm", "ZALM82");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z120.htm", "ZALM120");
				/* vespery */
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_SADE");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z88.htm", "ZALM88_I");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z88.htm", "ZALM88_II");
				/* vespery */
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_KOF");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z94.htm", "ZALM94_I");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z94.htm", "ZALM94_II");
				/* vespery */
				...
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_RES");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z128.htm", "ZALM128");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z129.htm", "ZALM129");
				/* vespery */
				...
				/* ranne chvaly */
					...
					set_zalm(3, MODL_RANNE_CHVALY, "z147.htm", "ZALM147,12-20");
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_SIN");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z133.htm", "ZALM133");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z140.htm", "ZALM140");
				/* vespery */
				...
				/* ranne chvaly */
					...
					set_zalm(3, MODL_RANNE_CHVALY, "z8.htm", "ZALM8");
				/* modlitba cez den */
					set_zalm(1, MODL_CEZ_DEN_VSETKY, "z119.htm", "ZALM119_TAU");
					set_zalm(2, MODL_CEZ_DEN_VSETKY, "z45.htm", "ZALM45_I");
					set_zalm(3, MODL_CEZ_DEN_VSETKY, "z45.htm", "ZALM45_II");
				/* posvatne citanie */
					if(je_odlisny_zaltar){
	...
	if((_global_opt[1] & BIT_OPT_1_MCD_DOPLNKOVA_PSALMODIA) == BIT_OPT_1_MCD_DOPLNKOVA_PSALMODIA){
		...
		if(_global_den.litobd == OBD_CEZ_ROK){
			_set_antifony_mcd_doplnkova_psalmodia();
		}/* pre cezroËnÈ obdobie nastavÌme aj antifÛny */
	}/* (_global_opt[1] & BIT_OPT_1_MCD_DOPLNKOVA_PSALMODIA) == BIT_OPT_1_MCD_DOPLNKOVA_PSALMODIA */
	else{
		/* 2006-02-07: doplnenÈ */
...
void _set_zalmy_velky_piatok(short int modlitba){
	...
	else if(((modlitba == MODL_PREDPOLUDNIM) || (modlitba == MODL_NAPOLUDNIE) || (modlitba == MODL_POPOLUDNI)) && ((_global_opt[1] & BIT_OPT_1_MCD_DOPLNKOVA_PSALMODIA) != BIT_OPT_1_MCD_DOPLNKOVA_PSALMODIA)){
...
/* 2009-03-27: tie istÈ ûalmy sa pouûÌvaj˙ aj pre sviatky sv‰t˝ch muûov */
...
void _set_zalmy_sviatok_panien(short int modlitba){
	/* pouûÌva sa aj pre sviatky sv‰t˝ch ûien */
	Log("_set_zalmy_sviatok_panien(%s) -- begin [pouûÌva sa aj pre sviatky sv‰t˝ch ûien]\n", nazov_modlitby(modlitba));
	if(modlitba == MODL_VESPERY){
...
void _set_zalmy_najsv_mena_jezisovho_sk_ofm(short int modlitba){
	/* 2011-03-16: doplnenÈ pre text_JAN_03; SK OFM maj˙ inÈ ako CZOP */
...
/* 2010-10-13: pre redemptoristov -- hlavn˝ titul kongreg·cie */
...
/* 2011-02-02: doplnenÈ pre SJ (31JUL) */
...
/* 2011-03-17: doplnenÈ pre OFM, 24APR; podæa _set_zalmy_sviatok_muc(); */
	...
	if(
		...
		((_global_den.den == 1) && (_global_den.mesiac - 1 == MES_NOV))
			...
			if((_global_modlitba != MODL_PREDPOLUDNIM) && (_global_modlitba != MODL_NAPOLUDNIE) && (_global_modlitba != MODL_POPOLUDNI)){
				Log("keÔûe nejde o modlitbu cez deÚ, preskakujeme nastavenia (vöetky boli nastavenÈ z vlastnej Ëasti)...\n");
				/* 2009-01-06: pre Premenenie P·na ch˝balo nastavenie kompletÛria vo vlastnej Ëasti, preto sa d·valo chybne; doplnenÈ na prÌsluönom mieste */
				return;
			}
			else 
				if(_global_den.denvt == DEN_NEDELA){
					Log("keÔûe ide o modlitbu cez deÚ, nastavujeme len ûalmy z nedele pre MCD a preskakujeme ostatnÈ nastavenia (vöetky ostatnÈ boli nastavenÈ z vlastnej Ëasti)...\n");
					zaltar_zvazok(den, tyzzal, _global_den.litobd, ZALTAR_IBA_ZALMY_HYMNUS_MCD);
					return;
				}
				else{
					Log("keÔûe ide o modlitbu cez deÚ MIMO nedele, nastavujeme vöetky Ëasti ak nasleduje - zo dÚa...\n");
					/* ûiaden return :) */
				}
	}
	else{
		Log("NEjde o: premenenie p·na || petra a pavla || pov˝öenie sv. krÌûa || vöetk˝ch sv‰t˝ch || nanebovzatia PM...\n");
	}
...
#define _adv1_antifony {\
	...
	Log("ZaËiatok veækÈho switch()-u podæa liturgick˝ch obdobÌ\nTeraz nasleduje veæk˝ switch() podæa liturgick˝ch obdobÌ...\n");
	switch(litobd){
/* switch(litobd), case OBD_ADVENTNE_I -- begin ----------------------------------------------- */
		case OBD_ADVENTNE_I :/* do 16. decembra */
			...
			if(den == DEN_NEDELA){ /* nedeæa: 1.-3. adventn· nedeæa */
				/* prve vespery */
				/* 2007-12-04: bola tu dlho t·to pozn·mka: 
...
/* 2009-01-06: pre hymnus tu bolo:
	if(modlitba == MODL_PRVE_VESPERY)\
		c = pismenko_modlitby(MODL_VESPERY);\
 * avöak pre Ëesk˝ brevi·¯ je hymnus na 1. neöpory odliön˝ od toho na 2. neöpory, preto som to odstr·nil
 */
...
/* switch(litobd), case OBD_VIANOCNE_I -- begin ----------------------------------------------- */
		case OBD_VIANOCNE_I :/* do slavnosti zjavenia pana */
			...
			if((_global_den.den == 26) || (_global_den.den == 27) || (_global_den.den == 28)){
				...
				/* 2009-01-06: modlitba cez deÚ je z okt·vy narodenia P·na, preto bola vyÚat· z "else" vetvy aû za tento "if" */
			}
			else{
			...
			/* 2009-01-06: presunutÈ sem z "else" vetvy */
			modlitba = MODL_PREDPOLUDNIM;
			...
			if((_global_den.den == 1) && (_global_den.mesiac == 1)){ /* Panny Marie Bohorodicky */
				...
				modlitba = MODL_POSV_CITANIE;
				_bohorod_hymnus(_anchor_vlastne_slavenie);
				_set_zalmy_vian_oktava(_global_den.den, modlitba); // 2010-01-08: opravenÈ; pÙvodne bolo _set_zalmy_sviatok_marie(modlitba);
				_bohorod_antifony;
				_bohorod_kresponz(_anchor_vlastne_slavenie);
				...
				_sv_rodiny_kresponz(_anchor_vlastne_slavenie);
				_vlastne_slavenie_modlitba(_anchor_vlastne_slavenie);
				/* 2011-04-06: hoci s˙ vo vlastnej Ëasti uvedenÈ aj antifÛny pre modlitbu cez deÚ, s˙ rovnakÈ ako pre vianoËnÈ obdobie, preto netreba nastavovaù */
				...
				/* posvatne citanie, pridane 2004-04-28; presunutÈ 2006-01-24 sem a do Ëasti "nie nedeæa" kvÙli napr. Najsv. Trojici */
					...
					*/
					...
					/* 2010-10-13: pridanÈ: pre redemptoristov: 3. nedeæa v j˙li */ 
						...
						Log("  pre CSSR: ide o sl·vnosù NAJSVƒTEJäIEHO VYKUPITEºA, TITUL¡RNY SVIATOK KONGREG¡CIE: _file = `%s', _anchor = %s...\n", _file, _anchor);
						...
						_set_zalmy_krista_krala(modlitba);
						_vlastne_slavenie_hymnus(_anchor_vlastne_slavenie);
						/* 2008-11-29: bolo tu sÌce uvedenÈ "s˙ nastavenÈ ako 34. nedeæa cezroËnÈho obdobia vyööie", ale nastavovali sa 
						 * z cezroËnÈho obdobia; Vlado Kiö ma upozornil, ûe kr·tke responzÛrium m· byù zo sl·vnosti Krista Kr·æa
							_vlastne_slavenie_1citanie(_anchor_vlastne_slavenie);
							_vlastne_slavenie_2citanie(_anchor_vlastne_slavenie);
						*/
						_vlastne_slavenie_kresponz(_anchor_vlastne_slavenie);
...
#define _vnokt_modlitba {\
	...
	set_LOG_litobd;\
		...
		/* 2006-01-24: tu v skutoËnosti zaËÌna VEºKONO»N¡ OKT¡VA */
			 ...
			 */
			set_hymnus_kompletorium_obd(DEN_NEDELA, tyzzal, modlitba, litobd); /* 2011-04-28: den nastaven˝ na DEN_NEDELA; kvÙli JAZYK_CZ -- v okt·ve sa berie nedeæn˝ hymnus */
			set_kresponz_kompletorium_obd(den, tyzzal, modlitba, litobd);
			...
			if(den == DEN_NEDELA){ /* v skutoËnosti platÌ aj: (_global_den.denvr == DRUHA_VELKONOCNA_NEDELA) */
				/* 2007-12-06: pridanÈ kompletÛrium po prv˝ch veöper·ch */
				modlitba = MODL_PRVE_KOMPLETORIUM;
				set_hymnus_kompletorium_obd(den, tyzzal, modlitba, litobd);
				set_kresponz_kompletorium_obd(den, tyzzal, modlitba, litobd);
...
#define _vlastna_cast_modlitba_spompost {\
	...
	set_LOG_svsv;}
/* posv‰tznÈ ËÌtanie (2. hagiografickÈ ËÌtanie) -- na spomienku sv‰tca v pÙste */
...
/* 2008-10-15: doplnenÈ pre Ëesk˝ brevi·¯ */
...
/* 2009-01-25: doplnenÈ pre Ëesk˝ brevi·¯ */
...
// 2011-06-02: kedysi bolo definovanÈ _spolocna_cast_kresponz_ve := _vlastna_cast_kresponz_ve, ale pouûÌvame _spolocna_cast_kresp_ve definovanÈ inde
 ...
 * 2010-11-05: upravenÈ, lebo pÙvodne bolo pre v˝ber z (2) moûnostÌ: (_global_den.den MOD kolko) + 1
...
void _set_spolocna_cast(short int a, _struct_sc sc
						...
						, short int brat_antifony_mcd = NIE // "force" pre antifÛny pre modlitbu cez deÚ (na sviatky sa zvyËajne neberie zo spoloËnej Ëasti), doplnenÈ 2010-05-14
						){
	...
	if(a == MODL_SPOL_CAST_APOSTOL){
		...
		/* prvÈ veöpery */
		modlitba = MODL_PRVE_VESPERY;
		if(su_zalmy_prve_vespery_vlastne || ((_global_opt[OPT_1_CASTI_MODLITBY] & BIT_OPT_1_ZALMY_ZO_SVIATKU) == BIT_OPT_1_ZALMY_ZO_SVIATKU) || brat_zalmy == ANO){ /* 2006-02-04_ZALMY_ZO_SVIATKU_FIX; 2009-09-18: doplnenÈ brat_zalmy */
		...
		/* posvatne citanie */
		modlitba = MODL_POSV_CITANIE;
		if(su_zalmy_vlastne || ((_global_opt[OPT_1_CASTI_MODLITBY] & BIT_OPT_1_ZALMY_ZO_SVIATKU) == BIT_OPT_1_ZALMY_ZO_SVIATKU) || brat_zalmy == ANO){ /* 2006-02-04_ZALMY_ZO_SVIATKU_FIX; 2009-09-18: doplnenÈ brat_zalmy */
			Log("  _set_zalmy_sviatok_apostolov(%s)...\n", nazov_modlitby(modlitba));
			_set_zalmy_sviatok_apostolov(modlitba);
		}
		_spolocna_cast_full(modlitba);
		 ...
		 *             Pritom default pre _global_opt 2 sme zmenili na MODL_ZALMY_ZO_DNA.
		 *             Takto isto zmenenÈ na vöetk˝ch ostatn˝ch miestach - bez pozn·mky.
		 *             2006-01-25_ZALMY1NE_FIX
		 * 2011-04-12: _global_opt 2 je Ëasùou _global_opt 1 (BIT_OPT_1_ZALMY_ZO_SVIATKU)
		 */
		if(su_zalmy_vlastne || ((_global_opt[OPT_1_CASTI_MODLITBY] & BIT_OPT_1_ZALMY_ZO_SVIATKU) == BIT_OPT_1_ZALMY_ZO_SVIATKU) || brat_zalmy == ANO){ /* 2006-01-25_ZALMY1NE_FIX; 2009-09-18: doplnenÈ brat_zalmy */
			_set_zalmy_1nedele_rch();
		}
		_spolocna_cast_full(modlitba);
		if((_global_den.litobd == OBD_VELKONOCNE_I) || (_global_den.litobd == OBD_VELKONOCNE_II))
		...
		/* 2010-05-14: pridan· modlitba cez deÚ; ûalmy a antifÛny sa ber˙ vlastnÈ len pre sl·vnosù (Ë. 229); my ich pre istotu nastavujeme aj pre sviatky (Ë. 232)
		 * pre volanie _spolocna_cast_antifony() bolo treba zaviesù samostatn˝ "force" parameter pre antifÛny na modlitbu cez deÚ -- brat_antifony_mcd
		 */
		if((_global_den.typslav == SLAV_SLAVNOST) || (_global_den.typslav == SLAV_SVIATOK)){
			modlitba = MODL_PREDPOLUDNIM;
			if((_global_den.typslav == SLAV_SLAVNOST) || (brat_antifony_mcd == ANO)){
				_spolocna_cast_antifony;
			}
	...
	/* spolocna cast na sviatky duchovnych pastierov */
		...
		/* prvÈ veöpery */
		modlitba = MODL_PRVE_VESPERY;
		if(su_zalmy_prve_vespery_vlastne || ((_global_opt[OPT_1_CASTI_MODLITBY] & BIT_OPT_1_ZALMY_ZO_SVIATKU) == BIT_OPT_1_ZALMY_ZO_SVIATKU) || brat_zalmy == ANO){ /* 2006-02-04_ZALMY_ZO_SVIATKU_FIX; 2010-06-04/2009-09-18: doplnenÈ brat_zalmy */
	...
	/* spolocna cast na sviatky svatych zien */
		...
		if(_global_den.litobd != OBD_OKTAVA_NARODENIA){
			...
			_spolocna_cast_full(modlitba);
			_spolocna_cast_hymnus_rozne(modlitba, _anchor_pom, _anchor, _file);
			// odliönÈ kr·tke resp. pre veækonoËnÈ obdobie
			if((_global_den.litobd == OBD_VELKONOCNE_I) || (_global_den.litobd == OBD_VELKONOCNE_II))
	...
	/* spolocna cast na sviatky Panny Marie */
		 ...
		 * 2011-02-09: opravenÈ _spolocna_cast_2cit_rozne -> _spolocna_cast_2citanie
		 */
...
// 2006-01-19_LABEL // 2005-08-16: tu treba pokraËovaù
	...
	/* spolocna cast na oficium za zosnulych */
		...
		/* 2010-07-12: upravenÈ tak, ûe spoloËn· Ëasù na ofÌcium za zosnul˝ch vûdy berie vlastnÈ ûalmy 
		 * 2011-04-12: keÔûe _global_opt 2 je Ëasùou _global_opt 1 (BIT_OPT_1_ZALMY_ZO_SVIATKU), upravenÈ
		 */
...
void set_popis_svaty_rch_mcd_pc_vesp(){
	Log("set_popis_svaty_rch_mcd_pc_vesp() -- zaËiatok...\n");
...
#define _set_spolocna_cast(a, brat_antifony, brat_zalmy, brat_1citanie, brat_kresp_prosby, brat_2citanie, brat_antifony_mcd) _set_spolocna_cast(a, sc, brat_antifony, brat_zalmy, brat_1citanie, brat_kresp_prosby, brat_2citanie, brat_antifony_mcd)
...
void set_spolocna_cast(_struct_sc sc, short int poradie_svaty
	 ...
	 * "NepoökvrnenÈho Srdca prebl. Panny M·rie" -> "NepoökvrnenÈho Srdca Panny M·rie",
	 * preto je tam nastaveny este raz na dummy, vid ZNOVUNASTAVENIE_POPISU_NA_DUMMY */

	/* tu bola pasaz, nastavujuca _global_opt[OPT_3_SPOLOCNA_CAST] na sc.a1 v pripade,
	 * ze je neurcena;
	...
	/* 2007-09-28: doplnenÈ; 2009-10-27: pokusne doplnenÈ aj _global_svaty1.typslav */
	...
	if(sc.a1 != MODL_SPOL_CAST_NEURCENA){
		if(_global_opt[OPT_3_SPOLOCNA_CAST] == sc.a1){
			...
			_set_spolocna_cast(_global_opt[OPT_3_SPOLOCNA_CAST], brat_antifony, brat_zalmy, brat_1citanie, brat_kresp_prosby, brat_2citanie, brat_antifony_mcd);
		}
		else{
			Log("	neplatÌ _global_opt[OPT_3_SPOLOCNA_CAST] == sc.a1 ...\n");
...
short int sviatky_svatych(short int den, short int mesiac, short int poradie_svaty){
	 ...
	 * priradovat pocet = 1; */
	short int pocet = 1;
	/* 2009-07-27: doplnenÈ premennÈ pom_den a pom_mesiac na uchovanie pÙvodnÈho dÚa a mesiaca */
	...
	if((poradie_svaty < 1) || (poradie_svaty > 3)){ /* napr. aj UNKNOWN_PORADIE_SVATEHO */
		...
		_global_svaty1.kalendar = KALENDAR_NEURCENY; /* 2010-08-03: pridanÈ */
		_global_svaty2.kalendar = KALENDAR_NEURCENY; /* 2010-08-03: pridanÈ */
		_global_svaty3.kalendar = KALENDAR_NEURCENY; /* 2010-08-03: pridanÈ */
	}
	else{
	...
	LOG_ciara_sv;
	Log("ZaËiatok veækÈho switch()-u podæa mesiacov a dnÌ\nTeraz nasleduje veæk˝ switch() podæa mesiacov a dnÌ...\n");
		...
		case MES_JAN:
			switch(den){
				...
				case 3: /* MES_JAN -- 03JAN */
					/* 2008-12-04: pridanÈ pre czop; 
					 * 2009-03-24: zmenenÈ aj pre ostatnÈ, pretoûe je to vo vöeobecnom kalend·ri 
					 * 2011-01-11: dominik·ni maj˙ mnoho vecÌ naviac; v latinskom je samostatne len ant. pre ben+magn, 2. ËÌtanie a modlitba
					 * 2011-03-16: aj sk-ofm maj˙ povinn˙ spomienku
					 */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						if(poradie_svaty == 1){
							...
							_vlastna_cast_full(modlitba); // 2010-05-10: upravenÈ (pouûit˝ skr·ten˝ alias)
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* mieste povinnÈ spomienky podæa miestneho kalend·ra; technicky 10, hoci podæa smernÌc 11 */
						...
						if(poradie_svaty == 1){
							...
							if(_global_jazyk == JAZYK_CZ_OP){
								/* 2009-04-01: doplnenÈ invitatÛrium; 2011-01-11: len pre dominik·nov */
								modlitba = MODL_INVITATORIUM;
								_vlastna_cast_antifona_inv;

								modlitba = MODL_RANNE_CHVALY;
								_set_zalmy_najsv_mena_jezisovho_czop(modlitba);
								_vlastna_cast_full_okrem_prosieb(modlitba); // 2010-05-10: upravenÈ (pouûit˝ skr·ten˝ alias)
				...
				case 4: /* MES_JAN --04JAN */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						...
						; /* vo vöeobecnom kalend·ri nie je nijak· oslava */
					}/* vöeobecn˝ kalend·r */
					break;
				...
				case 7: /* MES_JAN -- 07JAN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						 ...
						 * 2010-03-15: pre dominik·nov samostatne
						 */
						if(poradie_svaty == 2){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
							...
							modlitba = MODL_RANNE_CHVALY;
							_vlastna_cast_full_okrem_antifon_a_prosieb(modlitba); /* 2010-07-08: zjednoduöenÈ */
						...
						_global_svaty2.smer = 11; /* miestne povinne spomienky */
						...
						_global_svaty2.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
					break;
				...
				case 15: /* MES_JAN -- 15JAN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 11; /* miestne povinne spomienky */
						...
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
						...
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_NEURCENA);
						_global_svaty1.farba = LIT_FARBA_NEURCENA;
						_global_svaty1.kalendar = KALENDAR_VSEOBECNY_HU; /* 2010-08-03: pridanÈ */
					}
					else if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SVD)){
						if(poradie_svaty == 1){
							...
							/* 2010-10-18: ak je modlitba cez deÚ na sl·vnosù, tak by sa mali pouûiù ûalmy z doplnkovej psalmÛdie */
							if(_global_den.denvt != DEN_NEDELA) {
								_set_zalmy_mcd_doplnkova_psalmodia();
							}
							else {
						...
						_global_svaty1.smer = 3; /* miestne sl·vnosti podæa miestneho kalend·ra; pouûitÈ z technick˝ch dÙvodov 3, hoci podæa smernÌc je 4 */
						mystrcpy(_global_svaty1.meno, text_JAN_15_SVD[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ, MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_SK_SVD;
					}/* kalend·r pre KALENDAR_SK_SVD */
				...
				case 18: /* MES_JAN -- 18JAN */
					...
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty, ANO, ANO, ANO, NIE, NIE, NIE);
						...
						mystrcpy(_global_svaty1.meno, text_JAN_19[_global_jazyk], MENO_SVIATKU); // v maÔarsku 18. janu·ra
				...
				case 19: /* MES_JAN -- 19JAN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_JAN_19[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA, MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
				...
				case 20: /* MES_JAN -- 20JAN */
					...
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						...
						_global_svaty3.smer = 12; /* lubovolne spomienky */
						pocet = 3;
				...
				case 21: /* MES_JAN -- 21JAN */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						_set_zalmy_1nedele_rch(); /* 2011-01-27: doplnenÈ */
						if(_global_jazyk == JAZYK_SK){ /* 2008-10-15: odvetvenÈ len pre Slovensko */
						...
						modlitba = MODL_POSV_CITANIE;
						if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ_OP)){ /* 2009-07-28: odvetvenÈ len pre Slovensko a dominik·nsky brvi·¯ */
							_vlastna_cast_hymnus;
						}
						_vlastna_cast_modlitba;
						_vlastna_cast_2citanie;
						...
						modlitba = MODL_VESPERY;
						_set_zalmy_sviatok_muc(modlitba); /* 2011-01-27: doplnenÈ */
						if(_global_jazyk == JAZYK_SK){ /* 2008-10-15: odvetvenÈ len pre Slovensko */
							_vlastna_cast_full_okrem_prosieb(modlitba);
						}
						else{
				...
				case 28: /* MES_JAN --28JAN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						 ...
						 * 2010-03-26: pre dominik·nov samostatne
						 */
						if(poradie_svaty == 2){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
							...
							modlitba = MODL_POSV_CITANIE;
							_vlastna_cast_full(modlitba);
							/* 2010-07-06: doplnenÈ ûalmy, ktorÈ zatiaæ nikde inde nie s˙ v tomto radenÌ pouûitÈ */
							set_zalm(1, modlitba, "z1.htm", "ZALM1");
							set_zalm(2, modlitba, "z21.htm", "ZALM21");
							set_zalm(3, modlitba, "z92.htm", "ZALM92");

							_vlastna_cast_mcd_kcitresp_modl; // 2010-05-10: upravenÈ (pouûit˝ skr·ten˝ alias)
			...
			switch(den){
				...
				case 2: /* MES_FEB -- 02FEB */
					...
					if((poradie_svaty == UNKNOWN_PORADIE_SVATEHO) || (poradie_svaty == 1)){
						...
						modlitba = MODL_PRVE_VESPERY;
						_vlastna_cast_full(modlitba);
						_set_zalmy_sviatok_obetovania(modlitba); // 2010-02-04: opravenÈ
				...
				case 4: /* MES_FEB -- 04FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_FEB_04_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA, MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 5: /* MES_FEB -- 05FEB */
					/* 2011-02-18: sv. agaty je aj vo zv‰zku II, preto som to obalil "pÙstnou spomienkou" */
					if(poradie_svaty == 1){
						/* na spomienku v pÙste */
						if(je_post){
							/* 2011-03-17: doplnenÈ nastavenie popisu */
							if(query_type != PRM_DETAILY)
								set_popis_svaty_rch_mcd_pc_vesp();
							...
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty);
							modlitba = MODL_RANNE_CHVALY;
							/* 2010-05-14: antifÛna na benediktus/magnifikat: vlastn· sa berie iba na spomienku v pÙstnom obdobÌ 
							 * 2011-02-18: tak je to vo zv‰zku II (pÙst+veæk· noc); avak v III je to norm·lne, vlastn· ant.; opravenÈ
							 */
							_vlastna_cast_benediktus;
							_vlastna_cast_modlitba;
				...
				case 6: /* MES_FEB -- 06FEB */
					...
					_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_VIAC_MUCENIKOV);
					_global_svaty1.farba = LIT_FARBA_CERVENA; /* 2006-08-19: pridanÈ */
					/* 2010-12-07: pridanÈ pre jezuitov */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SJ)){
						mystrcpy(_global_svaty1.meno, text_FEB_06_SJ[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.kalendar = KALENDAR_SK_SJ;
					}
					/* 2011-03-16: pridanÈ pre frantiök·nsku rodinu */
					else if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
				...
				case 7: /* MES_FEB -- 07FEB */
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_ZA_ZOSNULYCH);
						_global_svaty1.farba = LIT_FARBA_FIALOVA_CIERNA; /* 2006-08-19: pridanÈ */
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
					else if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SDB)){
						if(poradie_svaty == 1){
				...
				case 9: /* MES_FEB -- 09FEB */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SDB)){
						...
						_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty1.smer = 12; /* lubovolne spomienky */
						_global_svaty1.typslav_lokal = LOKAL_SLAV_SPOMIENKA_FMA;
				...
				case 10: /* MES_FEB -- 10FEB */
					if(poradie_svaty == 1){
						...
						if(je_post){
							...
							/* 2010-05-14: antifÛna na benediktus/magnifikat: vlastn· sa berie iba na spomienku v pÙstnom obdobÌ 
							 * 2011-02-18: tak je to vo zv‰zku II (pÙst+veæk· noc); avak v III je to norm·lne, vlastn· ant.; opravenÈ
							 * naviac, ant. na veöpery vo zv‰zku pre 10.2. ch˝ba; je len v zv‰zku II... (III predpoklad· pouûitie zo spol. Ëasti)
							 */
							_vlastna_cast_magnifikat;
							_vlastna_cast_modlitba;
						}/* nie je_post */
				...
				case 12: /* MES_FEB -- 12FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_FEB_12_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 13: /* MES_FEB --13FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_FEB_13_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
				...
				case 18: /* MES_FEB -- 18FEB */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_FEB_18_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
				...
				case 22: /* MES_FEB -- 22FEB */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						_vlastna_cast_full_okrem_kresp_a_prosieb(modlitba); /* 2010-07-08: zjednoduöenÈ */

						modlitba = MODL_POSV_CITANIE;
						_vlastna_cast_full(modlitba); /* 2010-07-08: zjednoduöenÈ */
		...
		case MES_MAR:
			switch(den){
				...
				case 4: /* MES_MAR -- 04MAR */
					...
					/* 2011-03-07: opravenÈ na æubovoæn˙ spomienku */
					_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
					_global_svaty1.smer = 12; /* lubovolne spomienky */
				...
				case 9: /* MES_MAR -- 09MAR */
					...
					_global_svaty1.kalendar = KALENDAR_VSEOBECNY; /* 2010-08-03: pridanÈ */
					break;
/* 2011-02-18: do 9. marca s˙ propri· vo zv‰zku III (cezroËnÈ obdobie), potom sa pokraËuje aû dÚom 12. m·ja; 
 *             zruöenÈ preto Ëasti "else" vetiev if(je_post), lebo nie s˙ potrebnÈ */
				...
				case 15: /* MES_MAR -- 15MAR */
					...
					if((_global_den.denvt == DEN_SOBOTA) && (_global_den.rok == 2008)){
						...
						goto label_19_MAR;
					}/* vöeobecn˝ kalend·r -- m· prednosù, lebo sl·vnosù sv. Jozefa... */
					else if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						if(poradie_svaty == 1){
						...
						_global_svaty1.typslav = SLAV_SVIATOK;
						_global_svaty1.smer = 8; /* miestne sviatky */
						mystrcpy(_global_svaty1.meno, text_MAR_15_CSSR[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ_REHOLNIK, MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_SK_CSSR;
					}/* kalend·r pre KALENDAR_SK_CSSR */
...
label_19_MAR:
					...
					if((poradie_svaty == UNKNOWN_PORADIE_SVATEHO) || (poradie_svaty == 1)){
						...
						modlitba = MODL_POSV_CITANIE;
						_vlastna_cast_full(modlitba); /* 2010-07-08: zjednoduöenÈ */
						_set_zalmy_sviatok_sv_muzov(modlitba); /* 2009-03-27: doplnenÈ */
		...
		case MES_APR:
			switch(den){
				...
				case 5: /* MES_APR -- 05APR */
					/* 2009-03-25: pre Slovensko, »esko atÔ. podæa vöeobecnÈho kalend·ra sv. Vincenta Ferrera, pre dominik·nov presunutÈ na 5.5.... 
					 * 2009-05-15: aj pre dominik·nov platÌ vöeobecn˝ kalend·r
					 */
					if(poradie_svaty == 1){
						/* na spomienku v pÙste */
						if(je_post){
				...
				case 20: /* MES_APR -- 20APR */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						if(poradie_svaty == 1){
							...
							/* 2009-07-10: doplnenÈ invitatÛrium a niektorÈ Ëasti z vlastnej Ëasti */
							modlitba = MODL_INVITATORIUM;
							_vlastna_cast_antifona_inv;
						...
						_global_svaty1.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_APR_20[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA, MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
				...
				case 23: /* MES_APR -- 23APR */
					...
					if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						if(poradie_svaty == 1){
							...
							/* 2008-12-10: doplnenÈ pre JAZYK_CZ_OP - vlastn˝ hymnus a niektorÈ Ëasti pre rch a v */
							/* 2009-08-25: opravenÈ a doplnenÈ aj pre JAZYK_CZ */
							modlitba = MODL_RANNE_CHVALY;
							if((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_CZ))){
								_vlastna_cast_full_okrem_prosieb(modlitba); /* 2010-07-08: zjednoduöenÈ */
							}
							else{
								_vlastna_cast_benediktus;
								_vlastna_cast_modlitba;
							...
							if((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_CZ))){
								/* 2009-08-27: doplnenÈ modlitby cez deÚ */
								_vlastna_cast_mcd_kcitresp_modl;
							}
						...
						if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
							...
							/* 2009-04-23: oprava: uû nie je æubovoæn· spomienka, ale povinn· spomienka */
							_global_svaty1.typslav = SLAV_SPOMIENKA;
							_global_svaty1.smer = 10; /* povinne spomienky podla vseobecneho kalendara */
						}
						...
						if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
							...
							_global_svaty2.smer = 12; /* lubovolne spomienky */
							pocet = 2;
							mystrcpy(_global_svaty2.meno, text_APR_23_OFM[_global_jazyk], MENO_SVIATKU);
							_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
							_global_svaty2.farba = LIT_FARBA_BIELA;
							_global_svaty2.kalendar = KALENDAR_SK_OFM;
						}/* kalend·r pre KALENDAR_SK_OFM */
				...
				case 25: /* MES_APR -- 25APR */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_POSV_CITANIE;
						_vlastna_cast_full_okrem_antifon(modlitba); /* 2010-07-08: zjednoduöenÈ */
				...
				case 28: /* MES_APR -- 28APR */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						/* 2009-07-10: odvetvenÈ pre dominik·nov;
						 * 2010-03-16: pre dominik·nov samostatne
						 */
						if(poradie_svaty == 3){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
						...
						_global_svaty3.smer = 11; /* miestne povinne spomienky */
				...
				case 29: /* MES_APR -- 29APR */
					...
					/* 2006-01-11: pÙvodne to bola spomienka, ale don Val·bek ma upozornil, ûe ide o sviatok; upraven˝ n·zov
					_global_svaty1.typslav = SLAV_SPOMIENKA;
					_global_svaty1.smer = 10; - povinne spomienky podla vseobecneho kalendara 
					*/
					_global_svaty1.typslav = SLAV_SVIATOK;
				...
				case 30: /* MES_APR -- 30APR */
					/* 2009-03-24: upravenÈ; dominik·ni maj˙ pam·tku */
					if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_LA)){
						...
						/* CZ, CZOP: okrem Pia V. maj˙ aj sv. éigmunda */
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty);
			...
			switch(den){
				case 1: /* MES_MAY -- 01MAJ */
					if(poradie_svaty == 1){
						...
						if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
							/* 2009-07-27: doplnenÈ premennÈ pom_den a pom_mesiac na uchovanie pÙvodnÈho dÚa a mesiaca 
							 *             pre Ëesk˝ brevi·¯ sa totiû ber˙ niektorÈ Ëasti z 19. marca 
							 */
							pom_den = den;
							pom_mesiac = mesiac;
							den = 19;
						...
						if(_global_jazyk == JAZYK_CZ){
							/* 2010-05-14: pre Ëesk˝ brevi·¯ je aj hymnus na posv. ËÌtanie z 19. marca */
						...
						if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
							/* 2009-07-27: doplnenÈ premennÈ pom_den a pom_mesiac na uchovanie pÙvodnÈho dÚa a mesiaca 
							 *             pre Ëesk˝ brevi·¯ sa totiû ber˙ niektorÈ Ëasti z 19. marca 
							 *          -- v tejto Ëasti sa hodnoty upravuj˙ sp‰ù na pÙvodnÈ --
							 */
							den = pom_den;
							mesiac = pom_mesiac;
				...
				case 3: /* MES_MAY -- 03MAJ */
					if(poradie_svaty == 1){
						/* definovanie parametrov pre modlitbu */
						if(query_type != PRM_DETAILY)
							set_spolocna_cast(sc, poradie_svaty, ANO, ANO, ANO, ANO, ANO, NIE); // 2010-05-14: doplnenÈ Ôalöie parametre
						...
						modlitba = MODL_POSV_CITANIE;
						_vlastna_cast_modlitba;
						// 2010-05-03: Ëesk˝ brevi·¯ m· hymnus zo spol. Ëasti
						...
						/* 2008-05-08: doplnenÈ; 2009-10-21: upravenÈ
						 * 2010-05-03: Ëesk˝ brevi·¯ m· kr·tkÈ ËtenÌ a responz zo spol. Ëasti
						 * 2010-05-14: zapozn·mkovanÈ (ostalo len nastavenie modlitby), nakoæko bola rozöÌren· set_spolocna_cast() o nastavenie spoloËnej Ëasti pre mcd [zatiaæ len pre sviatky apoötolov]; 
						 *             aj slovensk˝ brevi·r to m· vlastne podæa spoloËnej Ëasti
						 */
						/*
						if(_global_jazyk == JAZYK_CZ){
				...
				case 4: /* MES_MAY -- 04MAJ */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SJ)){
						...
						_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty1.smer = 12; /* miestne lubovolne spomienky podla vseobecneho kalendara */
				...
				case 5: /* MES_MAY -- 05MAJ */
					/* 2009-03-25: pre dominik·nov presunutÈ z 5.4. zo vöeobecnÈho kalend·ra sv. Vincenta Ferrera... */
					if(_global_jazyk == JAZYK_CZ_OP){
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
				...
				case 8: /* MES_MAY - 08MAJ */
					...
					/* esle */ if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						if(poradie_svaty == 1){
				...
				case 10: /* MES_MAY -- 10MAJ */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						/* 2009-07-10: odvetvenÈ pre dominik·nov */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_MAJ_10_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_BISKUP);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
				...
				case 11: /* MES_MAY -- 11MAJ */
					...
					break;
/* 2011-02-18: do 9. marca s˙ propri· vo zv‰zku III (cezroËnÈ obdobie), potom sa pokraËuje aû dÚon 12. m·ja */
				case 12: /* MES_MAY -- 12MAJ */
					...
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						...
						_global_svaty3.kalendar = KALENDAR_VSEOBECNY_CZ; /* 2010-08-03: pridanÈ */
					}
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						if(poradie_svaty == 3){
				...
				case 13: /* MES_MAY -- 13MAJ */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SDB)){
						...
						_global_svaty1.typslav = SLAV_SVIATOK;
						_global_svaty1.smer = 8; /* miestne sviatky */
						_global_svaty1.typslav_lokal = LOKAL_SLAV_SLAVNOST_FMA;
				...
				case 16: /* MES_MAY -- 16MAJ */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						...
						if(poradie_svaty == 1){
							...
							modlitba = MODL_RANNE_CHVALY;
							_vlastna_cast_full(modlitba);
							_set_zalmy_1nedele_rch(); // 2011-05-17: kvÙli slovenskÈmu (CZ m· sviatok, tam je to automaticky)
							if((_global_den.litobd == OBD_VELKONOCNE_I) || (_global_den.litobd == OBD_VELKONOCNE_II))
								_vlastna_cast_kresponz_ve;
							...
							modlitba = MODL_VESPERY;
							_vlastna_cast_full(modlitba);
							_set_zalmy_sviatok_muc(modlitba); // 2011-05-17: kvÙli slovenskÈmu (CZ m· sviatok, tam je to automaticky)
							if((_global_den.litobd == OBD_VELKONOCNE_I) || (_global_den.litobd == OBD_VELKONOCNE_II))
								_vlastna_cast_kresponz_ve;
							/* inak zostane cezrocne, ale bez pripony */
				...
				case 17: /* MES_MAY -- 17MAJ */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* mieste povinnÈ spomienky podæa miestneho kalend·ra; technicky 10, hoci podæa smernÌc 11 */
						mystrcpy(_global_svaty1.meno, text_MAJ_17_OFM[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_SK_OFM;
					}/* kalend·r pre KALENDAR_SK_OFM */
				...
				case 18: /* MES_MAY -- 18MAJ */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						if(poradie_svaty == 1){
							...
							modlitba = MODL_POSV_CITANIE;
							_vlastna_cast_full(modlitba);
							/* 2011-03-17: doplnenÈ ûalmy, ktorÈ zatiaæ nikde inde nie s˙ v tomto radenÌ pouûitÈ */
							set_zalm(1, modlitba, "z1.htm", "ZALM1");
							...
							modlitba = MODL_VESPERY;
							_vlastna_cast_full(modlitba);
							/* 2011-03-17: doplnenÈ ûalmy, ktorÈ s˙ len pre prvÈ veöpery sviatku duchovn˝ch pastierov, _set_zalmy_sviatok_duch_past() */
							set_zalm(1, modlitba, "z113.htm", "ZALM113");
							set_zalm(2, modlitba, "z146.htm", "ZALM146");
							set_zalm(3, modlitba, "ch_ef1.htm", "CHVAL_EF1");
				...
				case 20: /* MES_MAY -- 20MAJ */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						...
						/* 2006-09-12: pÙvodne bola æubovoæn· spomienka na Sv. Klementa Marie Hofbauera - od 29.8.1991 pam·tka pre Moravu; "v Ëech·ch si lidÈ mohou vybrat buÔ Klementa nebo Bernardina na MoravÏ m·me p¯edepsanÈho jenom Klementa." - p. Franta, 2008-05-21 */
						else if(poradie_svaty == 2){
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty);
				...
				case 21: /* MES_MAY -- 21MAJ */
					...
					/* 2009-03-24: odvetvenÈ pre dominik·nov;
					 * 2009-05-16: upravenÈ, aby mali vöeobecn˝ kalend·r
					 */
					if(_global_jazyk == JAZYK_CZ_OP){
						if(poradie_svaty == 2){
							/* definovanie parametrov pre modlitbu */
						...
						_global_svaty2.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty2.meno, text_MAJ_21_CZOP[_global_jazyk]);
						_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty2.farba = LIT_FARBA_BIELA;
						_global_svaty2.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
					/* 2009-07-30: pridanÈ - Sv. Kriötofa Magallanesa, kÚaza a spoloËnÌkov, muËenÌkov */
					if(_global_jazyk == JAZYK_CZ_OP){
						if(poradie_svaty == 3){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
						...
						if(poradie_svaty == 1){
							...
							_vlastna_cast_modlitba;
							if(_global_jazyk == JAZYK_SK){
								_vlastna_cast_2citanie; // 2011-02-09: doplnen˝ pracovn˝ preklad
							}
				...
				case 22: /* MES_MAY -- 22MAJ */
					/* 2008-12-04: pridanÈ pre czop; 
					 * 2009-07-30: uû je aj vo vöeobecnom kalend·ri 
					 */
					if(poradie_svaty == 1){
						/* definovanie parametrov pre modlitbu */
						if(query_type != PRM_DETAILY)
				...
				case 24: /* MES_MAY -- 24MAJ */
					 ...
					 * 2011-03-17: doplnenÈ pre OFM sk
					 */
					if(_global_jazyk == JAZYK_CZ_OP){
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
						...
						_global_svaty1.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_MAJ_24_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
					/* else */ if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SDB)){
						...
						_global_svaty1.typslav = SLAV_SLAVNOST;
						_global_svaty1.smer = 3; /* miestne sl·vnosti podæa miestneho kalend·ra; pouûitÈ z technick˝ch dÙvodov 3, hoci podæa smernÌc je 4 */
						mystrcpy(_global_svaty1.meno, text_MAJ_24_SDB[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA_MARIA);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_SK_SDB;
					}/* kalend·r pre KALENDAR_SK_SDB */
					/* else */ if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						...
						if(poradie_svaty == 1){
							...
							/* Vöetko ostatnÈ je zo spoloËnej Ëasti na v˝roËie posviacky chr·mu */
							break;
						}
						_global_svaty1.smer = 8; /* miestne sviatky */
						_global_svaty1.typslav = SLAV_SVIATOK;
						mystrcpy(_global_svaty1.meno, text_MAJ_24_OFM[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_POSVIACKA_CHRAMU);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_SK_OFM;
					}/* kalend·r pre KALENDAR_SK_OFM */
				...
				case 25: /* MES_MAY -- 25MAJ */
					...
					_global_svaty3.farba = LIT_FARBA_BIELA; /* 2006-08-19: pridanÈ */
					_global_svaty3.kalendar = KALENDAR_VSEOBECNY; /* 2010-08-03: pridanÈ */
					break;
				...
				case 27: /* MES_MAY -- 27MAJ */
					...
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						...
						_global_svaty2.typslav = SLAV_SVIATOK;
						mystrcpy(_global_svaty2.meno, text_DEC_02_CZ[_global_jazyk], MENO_SVIATKU);
				...
				case 30: /* MES_MAY */
					...
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						if(poradie_svaty == 1){
							...
							modlitba = MODL_RANNE_CHVALY;
							_vlastna_cast_hymnus; // v Ëeskom brevi·ri m· vlastn˝ hymnus; 2009-08-13
							_vlastna_cast_benediktus;
							_vlastna_cast_modlitba;
				...
				case 31: /* MES_MAY -- 31MAJ */
					...
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						if(poradie_svaty == 1){
							...
							/* 2009-03-27: doplnenÈ invitatÛrium */
							modlitba = MODL_INVITATORIUM;
							_vlastna_cast_antifona_inv;
			...
			switch(den){
				...
				case 4: /* MES_JUN -- 04JUN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_JUN_04_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_MUCENIK, MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_CERVENA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 8: /* MES_JUN -- 08JUN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_JUN_08_CZOP[_global_jazyk]);
				...
				case 9: /* MES_JUN -- 09JUN */
					...
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SJ)){
						...
						pocet = 2;
						_global_svaty2.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty2.smer = 12; /* miestne lubovolne spomienky podla vseobecneho kalendara */
				...
				case 10: /* MES_JUN -- 10JUN */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_JUN_10_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_BISKUP);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}
				...
				case 11: /* MES_JUN -- 11JUN */
					if(poradie_svaty == 1){
						 ...
						 * _global_opt 2 = MODL_ZALMY_ZO_DNA; - ûalmy a antifÛny zo dÚa - ale len pre rannÈ chv·ly 
						 */
						if(query_type != PRM_DETAILY)
							set_spolocna_cast(sc, poradie_svaty);
				...
				case 12: /* MES_JUN -- 12JUN */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SDB)){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty1.meno, text_JUN_12_SDB[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_VIAC_MUCENIKOV);
						_global_svaty1.farba = LIT_FARBA_CERVENA;
						_global_svaty1.kalendar = KALENDAR_SK_SDB;
					}/* kalend·r pre KALENDAR_SK_SDB */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						...
						_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty1.smer = 12; /* lubovolne spomienky */
						mystrcpy(_global_svaty1.meno, text_JUN_12_OFM[_global_jazyk], MENO_SVIATKU);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_SK_OFM;
						pocet = 3;
						_global_svaty2.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty2.smer = 12; /* lubovolne spomienky */
						mystrcpy(_global_svaty2.meno, text_JUN_12_2_OFM[_global_jazyk], MENO_SVIATKU);
				...
				case 16: /* MES_JUN -- 16JUN */
					...
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
						...
						mystrcpy(_global_svaty2.meno, text_JUN_16_OFM[_global_jazyk], MENO_SVIATKU);
				...
				case 19: /* MES_JUN -- 19JUN */
					if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_HU)){ /* 2006-09-12: odvetvenÈ; 2011-06-07: pridanÈ aj HU */
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty);
						...
						if(poradie_svaty == 1){
							...
							modlitba = MODL_RANNE_CHVALY;
							_vlastna_cast_benediktus; /* 2008-06-17: doplnenÈ */
							_vlastna_cast_modlitba;
						...
						/* 2008-06-19: zmenenÈ, povinn· spomienka len v Ëb-diecÈze */
				...
				case 21: /* MES_JUN -- 21JUN */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SJ)){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 10; /* miestne povinne spomienky podla vseobecneho kalendara -- 10 preto, lebo je to aj vo vöeobecnom kalend·ri */
				...
				case 24: /* MES_JUN -- 24JUN */
					...
					if((poradie_svaty == UNKNOWN_PORADIE_SVATEHO) || (poradie_svaty == 1)){
						...
						modlitba = MODL_POSV_CITANIE;
						_vlastna_cast_full(modlitba); /* 2010-07-08: zjednoduöenÈ */
						_set_zalmy_sviatok_sv_muzov(modlitba); /* 2009-07-06: upravenÈ - doplnenÈ */
					...
					if(_global_jazyk == JAZYK_SK){
						...
						_global_svaty1.typslav_lokal = LOKAL_SLAV_POZS_NAGYSZ_PATRON; /* 2011-06-07: pridanÈ */
					}
				...
				case 27: /* MES_JUN -- 27JUN */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						...
						/* moûno Ëasom dorobiù sl·vnosù pre jednu diecÈzu 
						_global_svaty1.typslav = SLAV_SLAVNOST;
						_global_svaty1.smer = 3; // slavnosti Pana, preblahoslavenej Panny Marie a svatych, uvedene vo vseobecnom kalendari 
						*/
						_global_svaty1.typslav = SLAV_SVIATOK;
				...
				case 29: /* MES_JUN -- 29JUN */
					...
					if((poradie_svaty == UNKNOWN_PORADIE_SVATEHO) || (poradie_svaty == 1)){
						...
						modlitba = MODL_POSV_CITANIE;
						_vlastna_cast_full(modlitba); /* 2010-07-08: zjednoduöenÈ; 2011-01-27: opravenÈ */
					...
					_global_svaty1.kalendar = KALENDAR_VSEOBECNY; /* 2010-08-03: pridanÈ */
					if(_global_jazyk == JAZYK_HU){
						_global_svaty1.typslav_lokal = LOKAL_SLAV_PECSI_EGYH_PATRON; /* 2011-06-07: pridanÈ */
					}
					break;
				case 30: /* MES_JUN -- 30JUN */
					...
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						...
						pocet = 2;
						_global_svaty2.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty2.smer = 12; /* mieste æubovoænÈ spomienky podæa miestneho kalend·ra */
						mystrcpy(_global_svaty2.meno, text_JUN_30_CSSR[_global_jazyk], MENO_SVIATKU);
						_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ, MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
						_global_svaty2.farba = LIT_FARBA_BIELA;
						_global_svaty2.kalendar = KALENDAR_SK_CSSR;
					}/* kalend·r pre KALENDAR_SK_CSSR */
					break;
			}; break; /* case MES_JUN */
/* --------------- 07 j˙l --------------- */
			...
			switch(den){
				...
				case 3: /* MES_JUL -- 03JUL */
					if(poradie_svaty == 1){
						...
						_vlastna_cast_2citanie;
						if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
							/* 2008-10-15: odvetvenÈ len pre »esko
							 * 2008-11-29: pridanÈ czop - dominik·nsk˝ brevi·¯ */
							_vlastna_cast_hymnus;
						}

						/* 2009-08-17: doplnenÈ kr·tke ËÌtanie zo spol. Ëasti; modlitba ako na rannÈ chv·ly; 
						 * 2009-10-21: upravenÈ; doplnenÈ kr·tke resp.; 
						 * 2010-05-14: zapozn·mkovanÈ (ostalo len nastavenie modlitby), nakoæko bola rozöÌren· set_spolocna_cast() o nastavenie spoloËnej Ëasti pre mcd [zatiaæ len pre sviatky apoötolov] 
						 */
						// _vlastna_cast_mcd_kcitresp_modl;
						_vlastna_cast_mcd_modlitba;
				...
				case 4: /* MES_JUL -- 04JUL */
					if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_HU) || (_global_jazyk == JAZYK_LA)){
						/* 2009-07-09: odvetvenÈ len pre SK; 2009-08-25: je aj pre cz+czop, ale aû ako 2. v poradÌ 
						 * 2011-06-30: pridanÈ aj HU a LA
						 */
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
							...
							if(_global_jazyk != JAZYK_SK){
								/* SK nem· veöpery, lebo s˙ 1. veöpery zo sv. cyrila a metoda */
								modlitba = MODL_VESPERY;
								_vlastna_cast_modlitba;
							}
							break;
						...
						/* 2009-08-25: opravenÈ a doplnenÈ */
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty);
							...
							modlitba = MODL_POSV_CITANIE;
							if(_global_jazyk == JAZYK_CZ_OP)
								_vlastna_cast_hymnus; // 2009-08-25: pre dominik·nov je aj vlastn˝ hymnus
							_vlastna_cast_modlitba;
							_vlastna_cast_2citanie;
						...
						_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_ZENA_SKUTKYMIL, MODL_SPOL_CAST_SV_ZENA_MANZ /* 2006-08-08: doplnenÈ */);
						_global_svaty2.farba = LIT_FARBA_BIELA; /* 2006-08-19: pridanÈ */
						_global_svaty2.kalendar = KALENDAR_VSEOBECNY; /* 2010-08-03: pridanÈ */
					}
					break;
				case 5: /* MES_JUL -- 05JUL */
					if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_APOSTOL);
						_global_opt[OPT_3_SPOLOCNA_CAST] = _decode_spol_cast(_global_svaty1.spolcast).a1; /* 2010-07-06: doplnenÈ */
						_global_svaty1.typslav = SLAV_SLAVNOST;
						...
						if((poradie_svaty == UNKNOWN_PORADIE_SVATEHO) || (poradie_svaty == 1)){
							...
							modlitba = MODL_PRVE_VESPERY;
							_vlastna_cast_full(modlitba);
							/* 2009-07-06, upravenÈ: slovensk˝ brevi·r m· inÈ ûalmy */
							if(_global_jazyk == JAZYK_SK)
							...
							modlitba = MODL_RANNE_CHVALY;
							_vlastna_cast_full(modlitba);
							_set_zalmy_1nedele_rch(); /* 2008-08-15: doplnenÈ */
							...
							if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ)){
								...
								/* 2010-07-06: pre czop s˙ antifÛny a kr·tky responz pred 1. ËÌtanÌm zo spoloËnej Ëasti */
								_vlastna_cast_1citanie;
								_vlastna_cast_2citanie;
								_vlastna_cast_modlitba;
							}
							 ...
							 * 2010-07-06: pre CZ a CZOP hymnus ako na 1. veöpery
							 */
						...
						/* 2011-06-30: vo vöeobecnom kalend·ri sa sl·vi; presunutÈ na SK na 7. j˙la */
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty);
				...
				case 6: /* MES_JUL -- 06JUL */
					...
					_global_svaty1.kalendar = KALENDAR_VSEOBECNY; /* 2010-08-03: pridanÈ */
					if(_global_jazyk == JAZYK_CZ_OP){
						/* 2010-07-06: odvetvenÈ pre dominik·nov; pre dominik·nov samostatne */
						if(poradie_svaty == 2){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty);
				...
				case 9: /* MES_JUL -- 09JUL */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						if(poradie_svaty == 2){
							...
							/* 2009-07-09: doplnenÈ invitatÛrium */
							modlitba = MODL_INVITATORIUM;
							_vlastna_cast_antifona_inv;
						...
						_global_svaty2.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty2.meno, text_JUL_09_CZOP[_global_jazyk]);
				...
				case 11: /* MES_JUL -- 11JUL */
					...
					if(poradie_svaty == 1){
						...
						if(_global_jazyk == JAZYK_CZ_OP){
							_vlastna_cast_kresponz;
						}/* 2011-05-23: ËeskÈ CZOP m· v spoloËnej Ëasti: o sv. muûÌch odliönÈ ako vo vlastnej Ëasti... */
						_vlastna_cast_modlitba;
						...
						if(_global_jazyk == JAZYK_HU){
						  ...
						  * 2011-05-23: to istÈ aj kr·tke responzÛrium
						  */
						_vlastna_cast_modlitba;
				...
				case 16: /* MES_JUL -- 16JUL */
					if(poradie_svaty == 1){
						/* definovanie parametrov pre modlitbu */
						if(query_type != PRM_DETAILY)
							set_spolocna_cast(sc, poradie_svaty, ANO, ANO, ANO, ANO, ANO, NIE); /* 2009-09-18: ber˙ sa vöetky veci zo spol. Ëasti, hoci je to æub. spom. */
				...
				case 17: /* MES_JUL -- 17JUL */
					if(_global_jazyk == JAZYK_SK){
						...
						if(poradie_svaty == 1){
							...
							modlitba = MODL_RANNE_CHVALY;
							_vlastna_cast_full_okrem_kcit(modlitba); /* 2010-07-08: zjednoduöenÈ */
						...
						_global_svaty1.kalendar = KALENDAR_VSEOBECNY_CZ; /* 2010-08-03: pridanÈ */
						/* 2009-03-24: odvetvenÈ pre dominik·nov 
						 * 2010-07-06: pre dominik·nov samostatne
						 */
						if(_global_jazyk == JAZYK_CZ_OP){
							if(poradie_svaty == 2){
								/* definovanie parametrov pre modlitbu */
							...
							_global_svaty2.smer = 11; /* miestne povinne spomienky */
							mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
							strcat(_global_svaty2.meno, text_JUL_17_CZOP[_global_jazyk]);
							_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
							_global_svaty2.farba = LIT_FARBA_BIELA;
							_global_svaty2.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
						}/* czop only */
				...
				case 20: /* MES_JUL -- 20JUL */
					/* 2008-12-04: pridanÈ pre czop;
					 * 2009-07-15: upravenÈ pre vöeobecn˝ kalend·r
					 */
					if(poradie_svaty == 1){
						/* definovanie parametrov pre modlitbu */
						if(query_type != PRM_DETAILY)
				...
				case 22: /* MES_JUL -- 22JUL */
					if(poradie_svaty == 1){
						...
						_vlastna_cast_hymnus;
						_vlastna_cast_antifony;
						/* 2009-07-29: doplnenÈ ûalmy z nedele 1. t˝ûdÚa */
						_set_zalmy_1nedele_rch();
						_vlastna_cast_kresponz;
						_vlastna_cast_kcitanie; // 2009-07-29: m· byù rovnakÈ ako zo spoloËnej Ëasti sv‰t˝ch ûien
						_vlastna_cast_benediktus;
						_vlastna_cast_modlitba;
						...
						_vlastna_cast_hymnus;
						_vlastna_cast_antifony;
						/* 2009-07-29: doplnenÈ ûalmy zo spoloËnej Ëasti sv. ûien */
						_set_zalmy_sviatok_panien(modlitba);
						_vlastna_cast_kresponz;
						_vlastna_cast_kcitanie; // 2009-07-29: m· byù rovnakÈ ako zo spoloËnej Ëasti sv‰t˝ch ûien
						_vlastna_cast_magnifikat;
				...
				case 24: /* MES_JUL -- 24JUL */
					/* 2008-07-18: pridanÈ
					 * 2009-07-15: podæa direktÛria upraven· na SLAV_LUB_SPOMIENKA
					 * 2011-07-01: pre HU odvetvenÈ
					 */
					if(_global_jazyk == JAZYK_HU){
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
				...
				case 25: /* MES_JUL -- 25JUL */
					if(poradie_svaty == 1){
						...
						/* 2009-07-30: doplnenÈ kr·tke ËÌtanie zo spol. Ëasti; 
						 * 2009-10-21: doplnenÈ mcd in·Ë ako bolo d·vnejöie 
						 * 2010-05-14: zapozn·mkovanÈ (ostalo len nastavenie modlitby), nakoæko bola rozöÌren· set_spolocna_cast() o nastavenie spoloËnej Ëasti pre mcd [zatiaæ len pre sviatky apoötolov]
						 */
						// _vlastna_cast_mcd_kcitresp_modl;
						_vlastna_cast_mcd_modlitba;
				...
				case 27: /* MES_JUL -- 27JUL */
					if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						...
						if(_global_jazyk == JAZYK_SK){
							/* 2010-07-27: slovensk˝ brevi·r m·: zo spol. Ëasti sv‰t˝ch muûov */
							_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ_VIACERI);
							_global_svaty1.kalendar = KALENDAR_VSEOBECNY_SK; /* 2010-08-03: pridanÈ */
						}
						else{
				...
				/* 2004-08-14, duurko
				 * Sviatok Bl. Zdenky Schelingovej, panny a muËenice, ako 2. moûnosù
				 ...
				 */
					...
					if(_global_jazyk == JAZYK_SK){
						...
						_global_svaty2.typslav_lokal = LOKAL_SLAV_KONGREGACIA_SSK; /* 2011-01-27: pridanÈ */
				...
				case 31: /* MES_JUL -- 31JUL */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SJ)){
						...
						if(poradie_svaty == 1){
							...
							modlitba = MODL_RANNE_CHVALY;
							// v slovenskom brevi·ri m· vlastn˝ hymnus, v Ëeskom nie; 2008-09-09; v dominik·nskom ·no; 2009-09-09; aj v maÔarskom vlastn˝ hymnus; 2011-07-01
							if(_global_jazyk != JAZYK_CZ)
								_vlastna_cast_hymnus;
							_vlastna_cast_benediktus;
							_vlastna_cast_modlitba;
			...
			switch(den){
				case 1: /* MES_AUG -- 01AUG */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						if(poradie_svaty == 1){
							...
							/* 2010-10-11: ak je modlitba cez deÚ na sl·vnosù, tak by sa mali pouûiù ûalmy z doplnkovej psalmÛdie */
							if(_global_den.denvt != DEN_NEDELA) {
								_set_zalmy_mcd_doplnkova_psalmodia();
							}
							else {
				...
				case 2: /* MES_AUG -- 02AUG */
					...
					if(poradie_svaty == 1){
						...
						_global_svaty3.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty3.farba = LIT_FARBA_BIELA;
						_global_svaty3.kalendar = KALENDAR_SK_SDB;
					}/* kalend·r pre KALENDAR_SK_SDB */
					else if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SJ)){
						if(poradie_svaty == 3){
						...
						_global_svaty3.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty3.farba = LIT_FARBA_BIELA;
						_global_svaty3.kalendar = KALENDAR_SK_SJ;
					}/* kalend·r pre KALENDAR_SK_SJ */
					_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
					_global_svaty1.smer = 12; /* lubovolne spomienky */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty3.smer = 12; /* lubovolne spomienky */
						mystrcpy(_global_svaty3.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty3.meno, text_AUG_02_CZOP[_global_jazyk]);
				...
				case 7: /* MES_AUG -- 07AUG */
					if(poradie_svaty == 1){
						...
						/* 2010-08-03: doplnenÈ pre dominik·nov */
				...
				case 8: /* MES_AUG -- 08AUG */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ_OP)) // v slovenskom brevi·ri m· vlastn˝ hymnus, v Ëeskom nie; 2008-09-09
							_vlastna_cast_hymnus;
						_vlastna_cast_modlitba;
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						/* 2010-03-22: pre dominik·nov samostatne */
						if(poradie_svaty == 2){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty);

							/* 2010-08-03: doplnenÈ prvÈ veöpery a kompletÛrium po nich */
							modlitba = MODL_PRVE_VESPERY;
							_vlastna_cast_full(modlitba);
						...
						_global_svaty2.smer = 4; /* miestne slavnosti */
						mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
				...
				case 15: /* MES_AUG -- 15AUG */
					...
					if((poradie_svaty == UNKNOWN_PORADIE_SVATEHO) || (poradie_svaty == 1)){
						...
						modlitba = MODL_POSV_CITANIE;
						_vlastna_cast_full(modlitba); /* 2010-07-08: zjednoduöenÈ */
						_set_zalmy_sviatok_marie(modlitba); // 2009-05-18: doplnenÈ
				...
				case 17: /* MES_AUG -- 17AUG */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_AUG_17_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 18: /* MES_AUG -- 18AUG */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_AUG_18_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 20: /* MES_AUG -- 20AUG */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ_OP)) // v slovenskom brevi·ri m· vlastn˝ hymnus, v Ëeskom nie; 2008-09-09; v dominik·nskom ·no; 2009-07-09
							_vlastna_cast_hymnus;
						_vlastna_cast_benediktus;
						_vlastna_cast_modlitba;
				...
				case 28: /* MES_AUG -- 28AUG */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ_OP)) // v slovenskom brevi·ri m· vlastn˝ hymnus, v Ëeskom nie; 2008-09-09; aj v dominik·nskom m· vlastn˝ hymnus; 2009-09-09
							_vlastna_cast_hymnus;
						_vlastna_cast_benediktus;
						_vlastna_cast_modlitba;
			...
			switch(den){
				case 3: /* MES_SEP -- 03SEP */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ_OP)) // v slovenskom brevi·ri m· vlastn˝ hymnus, v Ëeskom nie; 2008-09-10; aj v dominik·nskom m· vlastn˝ hymnus; 2009-09-09
							_vlastna_cast_hymnus;
						_vlastna_cast_benediktus;
						_vlastna_cast_modlitba;
				...
				case 7: /* MES_SEP -- 07SEP */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SJ)){
						...
						if(_global_jazyk == JAZYK_SK){ /* 2006-09-12: odvetvenÈ pre Slovensko */
							...
							/* 2006-09-12: odvetvenÈ pre »esko 
							 * 2008-11-29: pridanÈ pre czop - domini·ni */
							_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
							_global_svaty1.smer = 12; /* lubovolne spomienky */
							_global_svaty1.kalendar = KALENDAR_VSEOBECNY_CZ; /* 2010-08-03: pridanÈ */
						}
				...
				case 10: /* MES_SEP -- 10SEP */
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						/* 2008-09-12: odvetvenÈ len pre »esko
						 * 2008-11-29: pridanÈ czop - dominik·nsk˝ brevi·¯ */
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
				...
				case 12: /* MES_SEP -- 12SEP */
					/* 2006-09-12: bolo odvetvenÈ len pre Slovensko;
					 * 2008-09-23: pre »esko je taktieû æubovoænou spomienkou
					 */
					if(poradie_svaty == 1){
						/* definovanie parametrov pre modlitbu */
						if(query_type != PRM_DETAILY)
						...
						modlitba = MODL_POSV_CITANIE;
						_vlastna_cast_modlitba;
						if(_global_jazyk == JAZYK_SK) /* 2009-07-10: pre ËeskÈ brevi·re vöetko zo spoloËnej Ëasti; 2009-08-11: modlitba je z vlastnej Ëasti */
							_vlastna_cast_2citanie;
				...
				case 15: /* MES_SEP -- 15SEP */
					...
					if(((poradie_svaty == UNKNOWN_PORADIE_SVATEHO) && (_global_jazyk == JAZYK_SK)) || (poradie_svaty == 1)){
						...
						if(/*(poradie_svaty == 1) && */ // 23/02/2000A.D.; zobrate z 8.dec; 28/03/2000A.D.
						  (query_type != PRM_DETAILY))
							set_spolocna_cast(sc, poradie_svaty, ANO, ANO, ANO, ANO, ANO, ANO); /* 2009-12-15: ber˙ sa vöetky veci zo spol. Ëasti; kvÙli prosb·m zo spol. Ëasti */
					...
					if(_global_jazyk == JAZYK_SK){
						/* 2006-09-12: odvetvenÈ pre Slovensko */
						_global_svaty1.typslav = SLAV_SLAVNOST;
						_global_svaty1.smer = 3; /* slavnosti Pana, preblahoslavenej Panny Marie a svatych, uvedene vo vseobecnom kalendari */
					}
					else if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
				...
				case 16: /* MES_SEP -- 16SEP */
					if(_global_jazyk == JAZYK_SK){ /* 2006-09-12: odvetvenÈ len pre Slovensko */
						...
						if(poradie_svaty == 1){
							...
							modlitba = MODL_RANNE_CHVALY;
							_vlastna_cast_full_okrem_prosieb(modlitba); // 2009-07-27: opravenÈ
							/*
							_vlastna_cast_benediktus;
							_vlastna_cast_modlitba;
							*/
				...
				case 18: /* MES_SEP -- 18SEP */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* mieste povinne spomienky podla vseobecneho kalendara */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_SEP_18_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 23: /* MES_SEP -- 23SEP */
					...
					if(poradie_svaty == 1){
						...
						_vlastna_cast_modlitba;
						if(_global_jazyk == JAZYK_CZ)
							_vlastna_cast_2citanie; // 2006-08-09: nem· zatiaæ vlastnÈ druhÈ ËÌtanie (2008-09-26: pre Ëesk˝ brevi·¯ uû m·)
					...
					/* 2008-09-23: upravenÈ (pÙvodne bola len æubovoæn· spomienka) */
					_global_svaty1.typslav = SLAV_SPOMIENKA;
					_global_svaty1.smer = 10; /* povinne spomienky podla vseobecneho kalendara */
				...
				case 26: /* MES_SEP -- 26SEP */
					/* 2009-03-24: pre Slovensko, »esko atÔ. podæa vöeobecnÈho kalend·ra sv. Kozmu a Dami·na, pre dominik·nov z 28.9. muËednÌkov...
					 * 2009-05-15: aj pre dominik·nov platÌ vöeobecn˝ kalend·r
					 * 2010-10-11: pre CSSR_SK: aj æubovoæn· spomienka Bl. Gaöpara Stanggassingera, kÚaza
					 */
					if(poradie_svaty == 1){
						/* definovanie parametrov pre modlitbu */
						if(query_type != PRM_DETAILY)
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty2.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty2.meno, text_SEP_26_CZOP[_global_jazyk]);
						_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_VIAC_MUCENIKOV);
						_global_svaty2.farba = LIT_FARBA_CERVENA; /* 2006-08-19: pridanÈ */
						_global_svaty2.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 28: /* MES_SEP -- 28SEP */
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){ /* 2008-10-09: odvetvenÈ len pre »esko; prevzatÈ podæa cyrila a metoda */
						...
						if((poradie_svaty == UNKNOWN_PORADIE_SVATEHO) || (poradie_svaty == 1)){
							...
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty, ANO, ANO, ANO, ANO, ANO, ANO); /* 2009-10-12: ber˙ sa vöetky veci zo spol. Ëasti */
							...
							_vlastna_cast_2citanie;
							_vlastna_cast_modlitba;
							// _set_zalmy_sviatok_muc(modlitba); // 2009-10-27: netreba, zabezpeËÌ predsunutie priradenÌ navrch a volanie set_spolocna_cast()
					...
					}/* 2008-10-09: odvetvenÈ len pre »esko */
					else{
						/* 2009-03-24: pre dominik·nov czop sa sl·vi 26.9. */
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty);
						...
						_global_svaty1.farba = LIT_FARBA_CERVENA; /* 2006-08-19: pridanÈ */
						_global_svaty1.kalendar = KALENDAR_VSEOBECNY; /* 2010-08-03: pridanÈ */
						/* na Slovensku sv. V·clav len æubovoæn· spomienka */
						_global_svaty1.typslav = SLAV_LUB_SPOMIENKA;
						_global_svaty1.smer = 12; /* lubovolne spomienky */
			...
			switch(den){
				...
				case 4: /* MES_OCT -- 04OKT */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						if(_global_jazyk != JAZYK_CZ_OP){ /* 2008-12-10: pre CZOP nie je vlastn˝ hymnus */
							_vlastna_cast_hymnus;
						}
						_vlastna_cast_benediktus;
						_vlastna_cast_modlitba;
				...
				case 5: /* MES_OCT -- 05OKT */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 12; /* lubovolne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_OKT_05_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP;
					}/* czop only */
				...
				case 7: /* MES_OCT -- 07OKT */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ_OP)){ /* 2008-10-15: odvetvenÈ len pre Slovensko; 2009-07-09: pridanÈ aj pre CZ_OP */
							_vlastna_cast_full_okrem_prosieb(modlitba);
						}
						else{
							_vlastna_cast_full_okrem_prosieb_a_hymnu(modlitba);
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						pocet = 2;
						_global_svaty2.typslav = SLAV_SLAVNOST;
						_global_svaty2.smer = 3; /* slavnosti Pana, preblahoslavenej Panny Marie a svatych, uvedene vo vseobecnom kalendari */
						mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
				...
				case 9: /* MES_OCT -- 09OKT */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty3.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty3.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty3.meno, text_OKT_09_CZOP[_global_jazyk]);
						_global_svaty3.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
						_global_svaty3.farba = LIT_FARBA_BIELA;
						_global_svaty3.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 12: /* MES_OCT -- 12OKT */
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						/* 2008-09-13: odvetvenÈ len pre »esko
						 * 2008-11-29: pridanÈ czop - dominik·nsk˝ brevi·¯ */
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
				...
				case 16: /* MES_OCT -- 16OKT */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CSSR)){
						...
						if(poradie_svaty == 1){
							...
							modlitba = MODL_RANNE_CHVALY;
							if(_global_jazyk == JAZYK_CZ_OP){ /* 2008-12-10: vlastn˝ hymnus */
								_vlastna_cast_hymnus;
							}
							_vlastna_cast_modlitba;
						...
						if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
							/* 2006-09-19: odvetvenÈ len pre »esko
							 * 2008-11-29: pridanÈ czop - dominik·nsk˝ brevi·¯ */
				...
				case 18: /* MES_OCT -- 18OKT */
					if(poradie_svaty == 1){
						...
						if(_global_jazyk != JAZYK_CZ){
							...
							_vlastna_cast_full_okrem_hymnu(modlitba); /* 2010-10-18: Ëesk˝ brevi·¯ nem· vlastn˝ hymnus */
						}
				...
				case 22: /* MES_OCT -- 22OKT */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_OKT_22_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_POSVIACKA_CHRAMU);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 25: /* MES_OCT -- 25OKT */
					...
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SDB)){
						...
						pocet = 2;
						_global_svaty2.smer = 4; /* mieste slavnosti */
						_global_svaty2.typslav = SLAV_SLAVNOST;
				...
				case 29: /* MES_OCT -- 29OKT */
					/* 2008-12-04: pridanÈ pre czop; 2009-08-11: pridanÈ aj pre CZ */
					if((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)){
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
			...
			switch(den){
				case 1: /* MES_NOV -- 01NOV */
					...
					if((poradie_svaty == UNKNOWN_PORADIE_SVATEHO) || (poradie_svaty == 1)){
						...
						/* definovanie parametrov pre modlitbu */
						sc = _decode_spol_cast(_global_svaty1.spolcast);
						Log("Vöetk˝ch sv‰t˝ch: sc: {%s, %s, %s}, svaty == %d\n\n", nazov_spolc(sc.a1), nazov_spolc(sc.a2), nazov_spolc(sc.a3), poradie_svaty);
				...
				case 2: /* MES_NOV -- 02NOV */
					...
					if(_global_den.denvt != DEN_NEDELA){
						...
						_global_svaty1.smer = 12; /* vsetkych vernych zosnulych; len "æubovoænÈ" sl·venie; odstavenie */
					}
				...
				case 5: /* MES_NOV -- 05NOV */
					...
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SDB)){
						...
						pocet = 2;
						_global_svaty2.typslav = SLAV_SPOMIENKA;
						_global_svaty2.smer = 10; /* mieste povinnÈ spomienky podæa miestneho kalend·ra; technicky 10, hoci podæa smernÌc 11 */
				...
				case 6: /* MES_NOV -- 06NOV */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty1.smer = 11; /* miestne povinne spomienky */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_NOV_06_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_VIAC_MUCENIKOV);
						_global_svaty1.farba = LIT_FARBA_CERVENA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 7: /* MES_NOV -- 07NOV */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						if(poradie_svaty == 1){
							...
							/* 2010-07-09: doplnenÈ invitatÛrium */
							modlitba = MODL_INVITATORIUM;
							_vlastna_cast_antifona_inv;
							...
							modlitba = MODL_POSV_CITANIE;
							_vlastna_cast_full(modlitba);
							/* 2010-07-09: doplnenÈ ûalmy, ktorÈ zatiaæ nikde inde nie s˙ v tomto radenÌ pouûitÈ */
							set_zalm(1, modlitba, "z1.htm", "ZALM1");
							set_zalm(2, modlitba, "z8.htm", "ZALM8");
							set_zalm(3, modlitba, "z16.htm", "ZALM16");
						...
						_global_svaty1.typslav = SLAV_SVIATOK;
						_global_svaty1.smer = 11; /* sviatky preblahoslavenej Panny Marie a svatych, uvedene vo vseobecnom kalendari - zmenenÈ na æubovoænÈ */
						mystrcpy(_global_svaty1.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty1.meno, text_NOV_07_CZOP[_global_jazyk]);
						_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_NEBRAT);
						_global_svaty1.farba = LIT_FARBA_BIELA;
						_global_svaty1.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 9: /* MES_NOV -- 09NOV */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_POSV_CITANIE;
						// _vlastna_cast_modlitba; zo spoloËnej Ëasti
						_vlastna_cast_2citanie;

						/* 2009-01-07: podæa brevi·ra (III., str. 1631) m· byù okrem antifÛn a ûalmov (tie s˙ zo dÚa)
				...
				case 11: /* MES_NOV -- 11NOV */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						_set_zalmy_1nedele_rch(); /* 2009-07-30: doplnenÈ podæa brevi·ra (ako napÌsal Vlado Kiö eöte ) */
						if(_global_jazyk == JAZYK_SK){ /* 2008-11-29: odvetvenÈ len pre Slovensko */
							_vlastna_cast_full_okrem_prosieb(modlitba);
						}
						else{
							_vlastna_cast_full_okrem_prosieb_a_hymnu(modlitba);
						...
						modlitba = MODL_VESPERY;
						_set_zalmy_sviatok_duch_past(modlitba); /* 2009-07-30: doplnenÈ podæa brevi·ra (ako napÌsal Vlado Kiö eöte ) */
						if(_global_jazyk == JAZYK_SK){ /* 2008-11-29: odvetvenÈ len pre Slovensko */
							_vlastna_cast_full_okrem_prosieb(modlitba);
						}
						else{
				...
				case 13: /* MES_NOV -- 13NOV */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SJ)){
						...
						if(poradie_svaty == 1){
							/* definovanie parametrov pre modlitbu */
							if(query_type != PRM_DETAILY)
								set_spolocna_cast(sc, poradie_svaty, ANO, ANO, ANO, ANO, ANO, ANO); /* 2009-12-08: ber˙ sa vöetky veci zo spol. Ëasti; je to spomienka */

							modlitba = MODL_RANNE_CHVALY;
							_set_zalmy_1nedele_rch();
							// 2009-12-08: pre dominik·nov prosby zo spol. Ëasti, pre Ëesk˝ brevi·r: z vlastnej Ëasti
							if(_global_jazyk == JAZYK_CZ){
								_vlastna_cast_full(modlitba);
							}
							else{
				...
				case 17: /* MES_NOV -- 17NOV */
					...
					_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_ZENA_SKUTKYMIL); /* 2010-11-18: v brevi·ri je len: "pre t˝ch, Ëo konali skutky milosrdenstva" */
					_global_svaty1.farba = LIT_FARBA_BIELA; /* 2006-08-19: pridanÈ */
					_global_svaty1.kalendar = KALENDAR_VSEOBECNY; /* 2010-08-03: pridanÈ */
					break;
				...
				case 21: /* MES_NOV -- 21NOV */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						if((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_CZ_OP)){ /* 2008-11-29: odvetvenÈ pre Slovensko a czop */
							_vlastna_cast_hymnus;
						}
						_vlastna_cast_benediktus;
						_vlastna_cast_modlitba;
				...
				case 24: /* MES_NOV -- 24NOV */
					...
					if(_global_jazyk == JAZYK_CZ_OP){
						...
						_global_svaty2.smer = 7; /* sviatky preblahoslavenej Panny Marie a svatych, uvedene vo vseobecnom kalendari */
						mystrcpy(_global_svaty2.meno, text_PRO_OP[_global_jazyk], MENO_SVIATKU);
						strcat(_global_svaty2.meno, text_NOV_24[_global_jazyk]);
						_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_VIAC_MUCENIKOV);
						_global_svaty2.farba = LIT_FARBA_CERVENA;
						_global_svaty2.kalendar = KALENDAR_CZ_OP; /* 2010-08-03: pridanÈ */
					}/* czop only */
				...
				case 25: /* MES_NOV -- 25NOV */
					/* 2006-09-13: odvetvenÈ pre Slovensko; 2008-12-04: aj pre CZ a CZ_OP */
					if(poradie_svaty == 1){
						/* definovanie parametrov pre modlitbu */
						if(query_type != PRM_DETAILY)
							set_spolocna_cast(sc, poradie_svaty);
			...
			switch(den){
				...
				case 5: /* MES_DEC -- 05DEC */
					if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SDB)){
						...
						_global_svaty1.typslav = SLAV_SPOMIENKA;
						_global_svaty1.smer = 11; /* miestne povinne spomienky */
						_global_svaty1.typslav_lokal = LOKAL_SLAV_SVIATOK_VDB;
				...
				case 7: /* MES_DEC -- 07DEC */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						if(_global_jazyk != JAZYK_CZ){ // 2009-12-08: pre cz nie je vlastn˝ hymnus
							_vlastna_cast_hymnus;
						}
						_vlastna_cast_modlitba;
...
label_8_DEC:
				...
				case 9: /* MES_DEC -- 09DEC */
					...
					/* 2008-12-04: pridanÈ pre czop; 2009-10-12: pridanÈ aj pre cz a sk */
					if(poradie_svaty == 1){
						/* definovanie parametrov pre modlitbu */
						if(query_type != PRM_DETAILY)
							set_spolocna_cast(sc, poradie_svaty);
				...
				case 27: /* MES_DEC -- 27DEC */
					if(poradie_svaty == 1){
						...
						modlitba = MODL_RANNE_CHVALY;
						_vlastna_cast_full_okrem_kresp(modlitba); // 2010-05-10: upravenÈ (pouûit˝ skr·ten˝ alias)
...
#define _srdca_pm_2cit {\
	...
	if((_global_den.denvr == (_global_r._ZOSLANIE_DUCHA_SV.denvr + 20)) && 
		...
		if(poradie_svaty == 1){
			...
			if(query_type != PRM_DETAILY)
			set_spolocna_cast(sc, poradie_svaty);
			/* ZNOVUNASTAVENIE_POPISU_NA_DUMMY, 2003-06-30; 2009-06-10: zapozn·mkovanÈ */
			...
			_vlastne_slavenie_benediktus(_anchor_vlastne_slavenie);
			_vlastne_slavenie_modlitba(_anchor_vlastne_slavenie);
			_vlastne_slavenie_popis(_anchor_vlastne_slavenie); /* 2009-06-10: doplnenÈ */
			...
			if((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM)){
				/* 2011-03-21: doplnenÈ pre OFM */

				/* najprv z vlastnej Ëasti (vöeobecnej) nastavÌme aj modlitbu pre mcd */
				modlitba = MODL_PREDPOLUDNIM;
				_vlastne_slavenie_modlitba(_anchor_vlastne_slavenie);
				...
				/* teraz z vlastnej Ëasti (OFM proprium) nastavÌme ostatnÈ Ëasti modlitieb */
				file_name_vlastny_kalendar(_global_kalendar);
				...
				_vlastne_slavenie_1citanie(_anchor_vlastne_slavenie);
				_set_zalmy_sviatok_marie(modlitba);
				// ToDo: eöte nastaviù antifÛny zo spoloËnej Ëasti na sviatky Panny M·rie...
