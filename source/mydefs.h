...
// 4. consider adding new calendar -> see [INCREMENT_FOR_NEW_CALENDAR]
//
...
//
// 4. technical strings for new language: STRING_3_FOR_NEW_LANGUAGE (usually suffices to copy from previous languages; mostly are the same for all languages)
...
#define FORCE_BIT_OPT_5_POST_5_HYMNS 154
#ifdef LONG_PARAM_NAMES
#define STR_FORCE_BIT_OPT_5_POST_5_HYMNS "FORCE_BIT_OPT_5_POST_5_HYMNS"
#else
#define STR_FORCE_BIT_OPT_5_POST_5_HYMNS "of5l5h"
#endif
...
#define TEXT_COPYRIGHT       "(c) 1999-2025 Juraj Vidéky"
...
#define XML_BIT_OPT_5_LENT_5_HYMNS              "BitOpt5Len5Hymns"
