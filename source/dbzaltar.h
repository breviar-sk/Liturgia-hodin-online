...
extern void _set_zalmy_ocd_ocarm_elias(short int modlitba);
...
extern void _set_zalmy_vesp_113_122_ef(short int modlitba);
...
extern const char* text_JAN_09_ES[POCET_JAZYKOV + 1];
...
extern const char* text_JAN_20_ES[POCET_JAZYKOV + 1];
...
extern const char* text_JAN_23_ES[POCET_JAZYKOV + 1];
extern const char* text_JAN_24[POCET_JAZYKOV + 1];
extern const char* text_JAN_25[POCET_JAZYKOV + 1];
extern const char* text_JAN_25_HU[POCET_JAZYKOV + 1];
...
extern const char* text_APR_13_ES[POCET_JAZYKOV + 1];
extern const char* text_APR_16[POCET_JAZYKOV + 1];
extern const char* text_APR_17_ES[POCET_JAZYKOV + 1];
extern const char* text_APR_21[POCET_JAZYKOV + 1];
extern const char* text_APR_23_1[POCET_JAZYKOV + 1];
extern const char* text_APR_23_2[POCET_JAZYKOV + 1];
extern const char* text_APR_23_HU[POCET_JAZYKOV + 1];
extern const char* text_APR_24[POCET_JAZYKOV + 1];
extern const char* text_APR_24_HU[POCET_JAZYKOV + 1];
...
extern const char* text_MAJ_04_ES[POCET_JAZYKOV + 1];
...
extern const char* text_MAJ_15_ES[POCET_JAZYKOV + 1];
...
extern const char* text_MAJ_30_ES[POCET_JAZYKOV + 1];
...
extern const char* text_JUN_05_1_HU[POCET_JAZYKOV + 1];
extern const char* text_JUN_05_2_HU[POCET_JAZYKOV + 1];
extern const char* text_JUN_06[POCET_JAZYKOV + 1];
extern const char* text_JUN_08_1_HU[POCET_JAZYKOV + 1];
extern const char* text_JUN_08_2_HU[POCET_JAZYKOV + 1];
...
extern const char* text_JUN_26_ES[POCET_JAZYKOV + 1];
...
extern const char* text_JUN_28_HU[POCET_JAZYKOV + 1];
...
extern const char* text_AUG_19_ES[POCET_JAZYKOV + 1];
extern const char* text_AUG_20[POCET_JAZYKOV + 1];
extern const char* text_AUG_21[POCET_JAZYKOV + 1];
extern const char* text_AUG_21_HU[POCET_JAZYKOV + 1];
...
extern const char* text_AUG_26_ES[POCET_JAZYKOV + 1];
extern const char* text_AUG_26_BY[POCET_JAZYKOV + 1];
extern const char* text_AUG_27[POCET_JAZYKOV + 1];
extern const char* text_AUG_27_HU[POCET_JAZYKOV + 1];
...
extern const char* text_AUG_30_HU[POCET_JAZYKOV + 1];
...
extern const char* text_SEP_24_ES[POCET_JAZYKOV + 1];
extern const char* text_SEP_24_1_HU[POCET_JAZYKOV + 1];
extern const char* text_SEP_24_2_HU[POCET_JAZYKOV + 1];
...
extern const char* text_SEP_28_HU[POCET_JAZYKOV + 1];
...
extern const char* text_OKT_03_HU[POCET_JAZYKOV + 1];
...
extern const char* text_OKT_05_ES[POCET_JAZYKOV + 1];
...
extern const char* text_OKT_12_ES[POCET_JAZYKOV + 1];
extern const char* text_OKT_13_ES[POCET_JAZYKOV + 1];
extern const char* text_OKT_14[POCET_JAZYKOV + 1];
extern const char* text_OKT_14_HU[POCET_JAZYKOV + 1];
...
extern const char* text_NOV_06_ES[POCET_JAZYKOV + 1];
...
extern const char* text_NOV_13_ES[POCET_JAZYKOV + 1];
...
extern const char* text_DEC_10_ES[POCET_JAZYKOV + 1];
...
extern const char* text_OKT_03_ES_SJ[POCET_JAZYKOV + 1];
...
extern const char* text_MAJ_17_ES_OFM[POCET_JAZYKOV + 1];
...
extern const char* text_JUN_10_OFM[POCET_JAZYKOV + 1];
...
extern const char* text_OKT_19_ES_OFM[POCET_JAZYKOV + 1];
...
extern const char* text_JAN_10_ES_OP[POCET_JAZYKOV + 1];
...
extern const char* text_JUL_04_OP[POCET_JAZYKOV + 1];
...
// --------------- OCD + OCARM propriá ---------------
extern const char* text_JAN_04_OCD_JAN_03_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JAN_08_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JAN_09_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JAN_20_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JAN_27_OCD[POCET_JAZYKOV + 1];
extern const char* text_JAN_29_OCARM[POCET_JAZYKOV + 1];
extern const char* text_FEB_01_OCARM[POCET_JAZYKOV + 1];
extern const char* text_FEB_04_OCD[POCET_JAZYKOV + 1];
extern const char* text_FEB_24_OCD[POCET_JAZYKOV + 1];
extern const char* text_MAR_19_OCARM[POCET_JAZYKOV + 1];
extern const char* text_MAR_20_OCARM[POCET_JAZYKOV + 1];
extern const char* text_APR_17_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_APR_18_OCD[POCET_JAZYKOV + 1];
extern const char* text_APR_24_OCD[POCET_JAZYKOV + 1];
extern const char* text_APR_28_OCD[POCET_JAZYKOV + 1];
extern const char* text_MAJ_04_OCD[POCET_JAZYKOV + 1];
extern const char* text_MAJ_04_OCARM[POCET_JAZYKOV + 1];
extern const char* text_MAJ_05_OCARM[POCET_JAZYKOV + 1];
extern const char* text_MAJ_07_OCARM[POCET_JAZYKOV + 1];
extern const char* text_MAJ_09_OCARM[POCET_JAZYKOV + 1];
extern const char* text_MAJ_17_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_MAJ_22_ES_OCD_OCARM[POCET_JAZYKOV + 1];
...
extern const char* text_JUN_12_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUN_14_OCD[POCET_JAZYKOV + 1];
extern const char* text_JUN_14_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUN_26_OCD[POCET_JAZYKOV + 1];
extern const char* text_JUL_02_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUL_05_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUL_07_OCD[POCET_JAZYKOV + 1];
extern const char* text_JUL_09_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUL_12_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUL_13_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUL_16_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUL_17_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUL_20_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUL_21_OCD_JUL_28_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUL_24_OCD[POCET_JAZYKOV + 1];
extern const char* text_JUL_26_OCARM[POCET_JAZYKOV + 1];
extern const char* text_JUL_28_OCD_JUL_24_OCARM[POCET_JAZYKOV + 1];
extern const char* text_AUG_07_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_AUG_09_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_AUG_12_OCARM[POCET_JAZYKOV + 1];
extern const char* text_AUG_17_OCARM[POCET_JAZYKOV + 1];
extern const char* text_AUG_18_OCD[POCET_JAZYKOV + 1];
extern const char* text_AUG_25_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_AUG_26_OCD[POCET_JAZYKOV + 1];
extern const char* text_AUG_26_OCARM[POCET_JAZYKOV + 1];
extern const char* text_SEP_01_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_SEP_11_OCD[POCET_JAZYKOV + 1];
extern const char* text_SEP_17_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_OKT_01_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_OKT_15_OCD[POCET_JAZYKOV + 1];
extern const char* text_OKT_30_OCD[POCET_JAZYKOV + 1];
extern const char* text_NOV_05_OCD_OCARM[POCET_JAZYKOV + 1];
extern const char* text_NOV_06_OCD_OCARM[POCET_JAZYKOV + 1];
