...
#define LOKAL_SLAV_KAPORSVAR_FELSZ					61 // not used
#define LOKAL_SLAV_VACI_FELSZ						62 // not used
#define LOKAL_SLAV_KAL_KECS_FOEGYH					63
#define LOKAL_SLAV_ESZTERGOM_BUDA_FOEGYH			64 // not used
#define LOKAL_SLAV_ARCI_CATHEDRAL_FOUNNEP_HU		65
#define LOKAL_SLAV_GYORI_SZEKESEGYH_FELSZ			66 // not used
