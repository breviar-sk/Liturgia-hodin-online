...
short int sviatky_svatych_01_januar(short int den, short int poradie_svaty, _struct_sc sc) {
	...
	case 3: // MES_JAN -- 03JAN
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			if (_global_jazyk == JAZYK_CZ_OP) {
				mystrcpy(_global_svaty2.meno, text_JAN_03[_global_jazyk], MENO_SVIATKU);
				_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_NEBRAT); // ??
			} // CZOP
			else {
				mystrcpy(_global_svaty2.meno, text_JAN_03_OP[_global_jazyk], MENO_SVIATKU); // for CZ OP celebrated as 3rd celebration
		...
		if (_global_jazyk == JAZYK_CZ_OP) {
			...
			mystrcpy(_global_svaty3.meno, text_JAN_03_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty3.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA);
	...
	case 8: // MES_JAN -- 08JAN
		...
		if ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_SDB)) {
			...
			_set_slavenie_typslav_smer(1, SLAV_SPOMIENKA, 10); // miestne povinné spomienky podľa miestneho kalendára; technicky 10, hoci podľa smerníc 11
			mystrcpy(_global_svaty1.meno, text_JAN_08_SDB[_global_jazyk], MENO_SVIATKU);
	...
	case 19: // MES_JAN -- 19JAN
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			pom_poradie = (_global_jazyk == JAZYK_CZ_OP) ? 2 : 1;
			...
			mystrcpy(_global_svaty(pom_poradie).meno, text_JAN_19_OP[_global_jazyk], MENO_SVIATKU);
	...
	case 22: // MES_JAN -- 22JAN
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			mystrcpy(_global_svaty(2).meno, text_JAN_22_OP[_global_jazyk], MENO_SVIATKU);
	...
	case 23: // MES_JAN -- 23JAN
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			_set_slavenie_typslav_smer(pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(pom_poradie).meno, text_JAN_23_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty(pom_poradie).spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ);
			_global_svaty(pom_poradie).farba = LIT_FARBA_BIELA;
			_global_svaty(pom_poradie).kalendar = _global_kalendar;
		}// CZOP only, kalendár pre KALENDAR_SK_OP
	...
	case 29: // MES_JAN -- 29JAN
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			mystrcpy(_global_svaty(1).meno, text_JAN_29_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty(1).spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_ZENA, MODL_SPOL_CAST_SV_ZENA_MANZ);
...
short int sviatky_svatych_02_februar(short int den, short int poradie_svaty, _struct_sc sc) {
	...
	case 8: // MES_FEB -- 08FEB
		...
		_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ_VYCH); // LA LH, vol. III, p. 1196: only one proprium to be taken: De communi sanctorum virorum: pro educatoribus.
		_global_svaty1.farba = LIT_FARBA_BIELA;
		_global_svaty1.kalendar = KALENDAR_VSEOBECNY;
	...
	case 24: // MES_FEB -- 24FEB
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA, MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
			_global_svaty2.farba = LIT_FARBA_BIELA;
			mystrcpy(_global_svaty2.meno, text_FEB_24_OP_2[_global_jazyk], MENO_SVIATKU);
			_global_svaty2.kalendar = _global_kalendar;
	...
	case MES_APR:
		...
		case 24: // MES_APR -- 24APR
			...
			if ((_global_jazyk == JAZYK_CZ) && (_global_kalendar == KALENDAR_CZ_OPRAEM)) {
				...
				_set_slavenie_typslav_smer(1, SLAV_SPOMIENKA, 10); // miestne povinné spomienky podľa miestneho kalendára; technicky 10, hoci podľa smerníc 11
				mystrcpy(_global_svaty1.meno, text_APR_24_OPRAEM_OP[_global_jazyk], MENO_SVIATKU);
				_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_BISKUP, MODL_SPOL_CAST_UCITEL_CIRKVI);
				_global_svaty1.farba = LIT_FARBA_BIELA;
			...
			// vo všeobecnom kalendári sú 23. apríla sv. Juraj a sv. Vojtech
				...
				if (_global_jazyk == JAZYK_CZ_OP) {
					...
					_set_slavenie_typslav_smer(3, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
					mystrcpy(_global_svaty(3).meno, text_APR_24_OPRAEM_OP[_global_jazyk], MENO_SVIATKU);
					_global_svaty(3).spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_BISKUP, MODL_SPOL_CAST_UCITEL_CIRKVI);
...
short int sviatky_svatych_05_maj(short int den, short int poradie_svaty, _struct_sc sc) {
	...
	case 4: // MES_MAY -- 04MAJ
		...
		if (_global_jazyk == JAZYK_CZ_OP) {
			...
			_set_slavenie_typslav_smer(1, SLAV_SVIATOK, 8); // miestne sviatky
			// _set_slavenie_typslav_smer(1, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			mystrcpy(_global_svaty1.meno, text_MAJ_04_OP_2[_global_jazyk], MENO_SVIATKU);
			_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_NEBRAT);
			_global_svaty1.farba = LIT_FARBA_CERVENA;
			_global_svaty1.kalendar = _global_kalendar;
		}// CZOP only
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			_set_slavenie_typslav_smer(pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(pom_poradie).meno, text_MAJ_04_OP[_global_jazyk], MENO_SVIATKU);
	...
	case 11: // MES_MAY -- 11MAJ
		...
		if ((_global_jazyk == JAZYK_SK) || (_global_jazyk == JAZYK_HU)) {
			...
			if ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP)) {
				...
				mystrcpy(_global_svaty2.meno, text_MAJ_13_OP[_global_jazyk], MENO_SVIATKU);
				_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA);
				_global_svaty2.farba = LIT_FARBA_BIELA;
				_global_svaty2.kalendar = _global_kalendar;
			}// kalendár pre KALENDAR_SK_OP
...
// do 9. marca sú propriá vo zväzku III (cezročné obdobie), potom sa pokračuje až dňom 12. mája
	...
	case 12: // MES_MAY -- 12MAJ
		...
		else if (((_global_jazyk == JAZYK_CZ) || (_global_jazyk == JAZYK_CZ_OP)) && (poradie_svaty == 3)) {
			// definovanie parametrov pre modlitbu
			if (query_type != PRM_DETAILY) {
				set_spolocna_cast(sc, poradie_svaty);
			}
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			pom_poradie = (_global_jazyk == JAZYK_CZ_OP) ? 4 : 3;
			...
			_set_slavenie_typslav_smer(pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(pom_poradie).meno, text_MAJ_12_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty(pom_poradie).spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA, MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
			_global_svaty(pom_poradie).farba = LIT_FARBA_BIELA;
			_global_svaty(pom_poradie).kalendar = _global_kalendar;
		}// CZOP only, kalendár pre KALENDAR_SK_OP
	...
	case 15: // MES_MAY -- 15MAJ
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			pom_poradie = (_global_jazyk == JAZYK_CZ_OP) ? 1 : 0;

			if (poradie_svaty == 1 + pom_poradie) {
			...
			else if (poradie_svaty == 2 + pom_poradie) {
				file_name_vlastny_kalendar(_global_kalendar);
			...
			_set_slavenie_typslav_smer(1 + pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(1 + pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(1 + pom_poradie).meno, text_MAJ_15_1_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty(1 + pom_poradie).spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ, MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
			_global_svaty(1 + pom_poradie).farba = LIT_FARBA_BIELA;
			_global_svaty(1 + pom_poradie).kalendar = _global_kalendar;

			pocet = 2 + pom_poradie;

			_set_slavenie_typslav_smer(2 + pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(2 + pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(2 + pom_poradie).meno, text_MAJ_15_2_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty(2 + pom_poradie).spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ, MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
			_global_svaty(2 + pom_poradie).farba = LIT_FARBA_BIELA;
			_global_svaty(2 + pom_poradie).kalendar = _global_kalendar;
		}// CZOP only, kalendár pre KALENDAR_SK_OP
	...
	case 20: // MES_MAY -- 20MAJ
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			pom_poradie = (_global_jazyk == JAZYK_CZ_OP) ? 3 : 2;
			...
			_set_slavenie_typslav_smer(pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(pom_poradie).meno, text_MAJ_20_OP[_global_jazyk], MENO_SVIATKU);
	...
	case 27: // MES_MAY -- 27MAJ
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			_set_slavenie_typslav_smer(pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(pom_poradie).meno, text_MAJ_27_OP[_global_jazyk], MENO_SVIATKU);
...
short int sviatky_svatych_06_jun(short int den, short int poradie_svaty, _struct_sc sc) {
	...
	case 5: // MES_JUN -- 05JUN
		...
		else if ((_global_jazyk == JAZYK_HU) && (poradie_svaty == 2)) {
			// definovanie parametrov pre modlitbu
			if (query_type != PRM_DETAILY) {
				set_spolocna_cast(sc, poradie_svaty);
			}
		...
		if (_global_jazyk == JAZYK_HU) {
			...
			_set_slavenie_typslav_smer(2, SLAV_SLAVNOST, 3); // miestne slávnosti Pána, preblahoslavenej Panny Márie a svätých; technicky 3, hoci podľa smerníc 4
			_global_svaty2.typslav_lokal = LOKAL_SLAV_DEBR_NYIREGY;
			mystrcpy(_global_svaty2.meno, text_JUN_05_HU[_global_jazyk], MENO_SVIATKU);
			_global_svaty2.spolcast = _encode_spol_cast(MODL_SPOL_CAST_POSVIACKA_CHRAMU);
			_global_svaty2.farba = LIT_FARBA_BIELA;
			_global_svaty2.kalendar = KALENDAR_VSEOBECNY_HU;
		}// HU only
	...
	case 8: // MES_JUN -- 08JUN
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			if (_global_jazyk == JAZYK_CZ_OP) {
				...
				_global_svaty1.typslav_lokal = LOKAL_SLAV_OP_MNISKY_PAMATKA;
			}
			else
			{
	...
	case 12: // MES_JUN -- 12JUN
		...
		if (((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OFM))
			...
			pom_poradie = (_global_jazyk == JAZYK_CZ) ? 1 : 0;
			...
			_set_slavenie_typslav_smer(1 + pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			mystrcpy(_global_svaty(1 + pom_poradie).meno, text_JUN_12_OFM[_global_jazyk], MENO_SVIATKU);
			_global_svaty(1 + pom_poradie).spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
			_global_svaty(1 + pom_poradie).farba = LIT_FARBA_BIELA;
			_global_svaty(1 + pom_poradie).kalendar = _global_kalendar;

			_set_slavenie_typslav_smer(2 + pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			mystrcpy(_global_svaty(2 + pom_poradie).meno, text_JUN_12_2_OFM[_global_jazyk], MENO_SVIATKU);
			_global_svaty(2 + pom_poradie).spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
			_global_svaty(2 + pom_poradie).farba = LIT_FARBA_BIELA;
			_global_svaty(2 + pom_poradie).kalendar = _global_kalendar;
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			_set_slavenie_typslav_smer(pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(pom_poradie).meno, text_JUN_12_OP[_global_jazyk], MENO_SVIATKU);
	...
	case 20: // MES_JUN -- 20JUN
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			_set_slavenie_typslav_smer(1, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty1.prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty1.meno, text_JUN_20_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA, MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
			_global_svaty1.farba = LIT_FARBA_BIELA;
			_global_svaty1.kalendar = _global_kalendar;
		}// CZOP only, kalendár pre KALENDAR_SK_OP
...
short int sviatky_svatych_07_jul(short int den, short int poradie_svaty, _struct_sc sc) {
	...
	case 4: // MES_JUL -- 04JUL
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			if (poradie_svaty == 2 + pom_poradie) {
			...
			else if (poradie_svaty == 3 + pom_poradie) {
			...
			mystrcpy(_global_svaty(2 + pom_poradie).meno, text_JUL_04_2_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty(2 + pom_poradie).spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ); 
			_global_svaty(2 + pom_poradie).farba = LIT_FARBA_BIELA;
			_global_svaty(2 + pom_poradie).kalendar = _global_kalendar;

			pocet = 3 + pom_poradie;

			_set_slavenie_typslav_smer(3 + pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(3 + pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(3 + pom_poradie).meno, text_JUL_04_1_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty(3 + pom_poradie).spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA, MODL_SPOL_CAST_SV_ZENA_SKUTKYMIL);
			_global_svaty(3 + pom_poradie).farba = LIT_FARBA_BIELA;
			_global_svaty(3 + pom_poradie).kalendar = _global_kalendar;
		}// CZOP only, kalendár pre KALENDAR_SK_OP
	...
	case 7: // MES_JUL -- 07JUL
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			_set_slavenie_typslav_smer(pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(pom_poradie).meno, text_JUL_07_OP[_global_jazyk], MENO_SVIATKU);
	...
	case 18: // MES_JUL -- 18JUL
		...
		if (_global_jazyk == JAZYK_CZ_OP) {
			...
			_set_slavenie_typslav_smer(1, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty1.prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty1.meno, text_JUL_18_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_BISKUP);
			_global_svaty1.farba = LIT_FARBA_BIELA;
			_global_svaty1.kalendar = _global_kalendar;
		}// CZOP only
	...
	case 22: // MES_JUL -- 22JUL
		...
		if (_global_jazyk == JAZYK_CZ_OP) {
			...
			_set_slavenie_typslav_smer(2, SLAV_SVIATOK, 7); // sviatky preblahoslavenej Panny Márie a svätých, uvedené vo všeobecnom kalendári
			mystrcpy(_global_svaty(2).meno, text_JUL_22[_global_jazyk], MENO_SVIATKU);
			_global_svaty(2).spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_ZENA);
			_global_svaty(2).farba = LIT_FARBA_BIELA;
	...
	case 27: // MES_JUL -- 27JUL
		...
		if (_global_jazyk == JAZYK_CZ_OP) {
			...
			_set_slavenie_typslav_smer(2, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(2).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(2).meno, text_JUL_27_OP[_global_jazyk], MENO_SVIATKU);
	...
	case 30: // MES_JUL -- 30JUL
		...
		if ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_CM)) {
			...
			_set_slavenie_typslav_smer(1, SLAV_SPOMIENKA, 10); // miestne povinné spomienky podľa miestneho kalendára; technicky 10, hoci podľa smerníc 11
			mystrcpy(_global_svaty1.meno, text_JUL_30_OFMCAP[_global_jazyk], MENO_SVIATKU);
			_global_svaty1.spolcast = _encode_spol_cast(MODL_SPOL_CAST_DUCH_PAST_KNAZ, MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
			_global_svaty1.farba = LIT_FARBA_BIELA;
			_global_svaty1.kalendar = _global_kalendar;
		}// kalendár pre KALENDAR_SK_CM
...
short int sviatky_svatych_09_september(short int den, short int poradie_svaty, _struct_sc sc) {
	...
	case 6: // MES_SEP -- 06SEP
		...
		if (((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP)) || (_global_jazyk == JAZYK_CZ_OP)) {
			...
			pom_poradie = (_global_jazyk == JAZYK_SK) ? 3 : 2;
...
short int sviatky_svatych_10_oktober(short int den, short int poradie_svaty, _struct_sc sc) {
	...
	case 11: // MES_OCT -- 11OKT
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			_set_slavenie_typslav_smer(pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(pom_poradie).meno, text_OKT_11_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty(pom_poradie).spolcast = _encode_spol_cast(MODL_SPOL_CAST_SV_MUZ_REHOLNIK);
			_global_svaty(pom_poradie).farba = LIT_FARBA_BIELA;
			_global_svaty(pom_poradie).kalendar = _global_kalendar;
		}// CZOP only, kalendár pre KALENDAR_SK_OP
	...
	case 14: // MES_OCT -- 14OKT
		...
		if ((_global_jazyk == JAZYK_CZ_OP) || ((_global_jazyk == JAZYK_SK) && (_global_kalendar == KALENDAR_SK_OP))) {
			...
			pom_poradie = (_global_jazyk == JAZYK_SK) ? 2 : 3;
			...
			_set_slavenie_typslav_smer(pom_poradie, SLAV_LUB_SPOMIENKA, 12); // ľubovoľné spomienky
			_global_svaty(pom_poradie).prik = VOLNA_LUBOVOLNA_SPOMIENKA; // ľubovoľná spomienka uvedená kurzívou bez popisu
			mystrcpy(_global_svaty(pom_poradie).meno, text_OKT_14_OP[_global_jazyk], MENO_SVIATKU);
			_global_svaty(pom_poradie).spolcast = _encode_spol_cast(MODL_SPOL_CAST_PANNA, MODL_SPOL_CAST_SV_ZENA_REHOLNIK);
			_global_svaty(pom_poradie).farba = LIT_FARBA_BIELA;
			_global_svaty(pom_poradie).kalendar = _global_kalendar;
		}// CZOP only, kalendár pre KALENDAR_SK_OP
...
short int sviatky_svatych_11_november(short int den, short int poradie_svaty, _struct_sc sc) {
	...
	case 24: // MES_NOV -- 24NOV
		...
		if (_global_jazyk == JAZYK_CZ_OP) {
			...
			_set_slavenie_typslav_smer(2, SLAV_SPOMIENKA, 10); // povinné spomienky podľa všeobecného kalendára
